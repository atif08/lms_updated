                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer-widget footer-about">
                        <div class="footer-logo">
                            <img src="{{ URL::asset('/frontend/img/logo.svg') }}" alt="logo">
                        </div>
                    ...
                    <div class="footer-widget footer-contact">
                        ...
                        <div class="footer-contact-info">
                            <div class="footer-address">
                                <img src="{{ URL::asset('/frontend/img/icon/icon-20.svg') }}" alt=""
                                     class="img-fluid">
                                <p> 3556 Beech Street, San Francisco,<br> California, CA 94108 </p>
                            </div>
                            <p>
                                <img src="{{ URL::asset('/frontend/img/icon/icon-19.svg') }}" alt=""
                                     class="img-fluid">
                                dreamslms@example.com
                            </p>
                            <p class="mb-0">
                                <img src="{{ URL::asset('/frontend/img/icon/icon-21.svg') }}" alt=""
                                     class="img-fluid">
                                +19 123-456-7890
                            </p>
                        </div>
