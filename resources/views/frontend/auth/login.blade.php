        ...
        <div class="col-md-6 login-wrap-bg">
            ...
            <div class="login-wrapper">
                        ...
                        <form method="post" action="{{ route('post.login') }}">
                            ...
                            <div class="input-block">
                                ...
                                <div class="pass-group">
                                    <input type="password" class="form-control pass-input" value="12345678"
                                           name="password"
                                           id="password">
                ...
                <div class="google-bg text-center">
                    ...
                    {{--                        <ul>--}}
                    {{--                            <li><a href="#"><img src="{{ URL::asset('/frontend/img/net-icon-01.png') }}"--}}
                    {{--                                                 class="img-fluid" alt="Logo"> Sign In using Google</a></li>--}}
                    {{--                            <li><a href="#"><img src="{{ URL::asset('/frontend/img/net-icon-02.png') }}"--}}
