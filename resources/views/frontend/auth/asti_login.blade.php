...
<head>
    ...
    <link
        ...
        rel="stylesheet"
    />
    <link rel="icon" href="{{URL::asset('frontend/img/login/favicon.ico')}}" type="image/x-icon" />
    <link
        rel="stylesheet"
    ...
    <style>
        body {
            background-image: url("build/img/login/asti-login-bg.jpg");
...
<body>
<div class="alert-container animate__animated animate__fadeInLeft">
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        <strong>ALERT:</strong>Important Login Information<br /><br />
        Attention users,<br/>
        When logging into the ASTI Portal, please double-check your login ID and password for accuracy.
...
<div class="container">
    <div class="row custom-pos">
        <div class="login-card">
            <img src="{{URL::asset('frontend/img/login/asti.webp')}}" alt="Logo" />
