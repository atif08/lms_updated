...
@section('content')
    ...
    <!-- About [image] -->
    <section id="about" class="section-1 highlights image-right" style="padding: 10px 0px">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row intro">
                        <div class="col-12 p-0">
                            <h3 class="featured alt">
                                Foundation Diploma in Higher Education
                            </h3>
                            <p style="text-align: justify">
                                ASTI Academy in Dubai offers a Foundation Diploma in Higher
                                Education (Level 3), carefully designed to support students
                                transitioning from secondary school to college life. This
                                course serves as a vital academic bridge, preparing learners
                                not only with essential subject knowledge but also the skills
                                and mindset required for success in higher education
                                environments. The program features a comprehensive,
                                internationally aligned curriculum that builds core
                                competencies in critical thinking, effective communication,
                                academic writing, and research methodologies. These areas are
                                crucial for students aiming to meet global university
                                standards and perform confidently in undergraduate studies.
                                What sets this diploma apart is its flexible progression
                                pathways. Upon successful completion, students can advance to
                                Level 4 programs or gain entry into first-year bachelor's
                                degree programs, either within the UAE or at partner
                                universities abroad. It also includes personalized academic
                                support, access to experienced faculty, and hands-on learning
                                opportunities, ensuring students are not only academically
                                prepared but also personally motivated to succeed. Whether
                                your goal is to study locally or pursue higher education
                                internationally, this diploma lays a strong foundation for
                ...
                <div class="col-12 col-md-6">
                    <a href="#">
                        <img src="/frontend/assets/images/level-3-foundation-diploma-in-higher-education-1.jpg"
                            class="fit-image" alt="Level-3 Foundation Diploma in Higher Education" />
                    </a>
                </div>
            </div>
        </div>
            ...
            <div id="section1" class="content-section" style="padding:10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <p>
                            The "Level 3 Foundation Diploma for Higher Education Studies" is
                            a comprehensive UK-accredited program offered at "ASTI Dubai",
                            designed to prepare students for successful progression into
                            undergraduate degree courses. It is ideal for recent school
                            leavers or international students seeking a structured academic
                            pathway to university-level education.
                        </p>
                        <p>
                            Ideal for recent school leavers and international students, the
                            diploma provides a structured and supportive learning
                            environment that focuses on developing essential academic
                            skills, subject knowledge, and English language proficiency. The
                            curriculum is designed to build confidence and competence in
                            research, critical thinking, communication, and independent
                            study — all key components for success at university level.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div id="section2" class="content-section" style="padding:10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <p>
                            The primary aim of this program is to equip learners with the
                            comprehensive academic skills, effective study techniques, and
                            foundational subject knowledge necessary to ensure a smooth and
                            confident transition into higher education. Whether students
                            plan to pursue their undergraduate studies locally within the
                            UAE or at international institutions abroad, this diploma is
                            structured to prepare them for the academic challenges and
                ...
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Academic English and Study Skills</td>
                                        <td>20 Credits</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Foundation Accounting and Economics</td>
                                        <td>20 Credits</td>
                                    </tr>
            ...
            <div id="section4" class="content-section" style="padding:10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <p>
                            The Level 3 Foundation Diploma in Higher Education Studies at
                            ASTI Dubai is a UK-accredited preparatory program designed to
                            provide students with the academic grounding necessary for
                            successful entry into undergraduate degree courses, both locally
                            and internationally. This one-year, full-time program focuses on
                            building essential academic skills such as critical thinking,
                            research techniques, academic writing, and effective
                            communication in English. In addition to enhancing general study
                            skills, students are introduced to foundational concepts in key
                            disciplines such as business, computing, mathematics, and social
                            sciences. The curriculum is specifically structured to support
                            recent high school graduates and international learners seeking
                            a structured and supportive transition into higher education. By
                            the end of the program, students are well-prepared to progress
                            to university-level study, equipped with the confidence,
                            knowledge, and academic discipline required to succeed in
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            Level 3 Foundation Diploma in Higher Education Studies
                                        </td>
                                        <td>UK Level 3</td>
                                        <td>Accredited</td>
                                        <td>120 Credits</td>
        ...
        <div class="container smaller">
            ...
            <div class="faq-container">
                <div class="faq">
                    ...
                    <p class="faq-text">
                        High school graduates or international students needing a
                        foundation before entering university.
                    </p>
                ...
                <div class="faq">
                    <h5 class="faq-title">
                        Is this diploma internationally recognized?
                    </h5>
                    <p class="faq-text">
                        Yes. It's accredited by OTHM (UK) and regulated by Ofqual, making
                        it widely accepted.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                ...
                <div class="faq">
                    <h5 class="faq-title">What can I study after this diploma?</h5>
                    <p class="faq-text">
                        You can progress into undergraduate degree programs in Business,
                        Management, IT, or other fields.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                ...
                <div class="swiper-container mid-slider items">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    <img src="/frontend/assets/images/testimonial/29.webp" alt="Adams Baker"
                                        class="person" />
                                    <h4>Riyaa M.</h4>
                                    <p style="text-align: justify">
                        ...
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    <img src="/frontend/assets/images/testimonial/9.webp" alt="Mary Evans"
                                        class="person" />
                                    <h4>Ahmed K.</h4>
                                    <p style="text-align: justify">
                        ...
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    <img src="/frontend/assets/images/testimonial/17.webp" alt="Nadia Malik"
                                        class="person" />
                                    <h4>Fatima Mariya</h4>
                                    <p style="text-align: justify">
                        ...
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    <img src="/frontend/assets/images/testimonial/10.webp" alt="Khalid Mansoor"
                                        class="person" />
                                    <h4>Mohammed S.</h4>
                                    <p style="text-align: justify">
                        ...
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    <img src="/frontend/assets/images/testimonial/11.webp" alt="Sara Khan"
                                        class="person" />
                                    <h4>Omar S.</h4>
                                    <p style="text-align: justify">
