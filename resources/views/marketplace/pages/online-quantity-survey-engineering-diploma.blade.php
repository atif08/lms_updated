...
@section('content')
                ...
                <div class="swiper-slide slide-center">
                    ...
                    <div class="slide-content row text-center">
                        <div class="col-12 mx-auto inner">
                            ...
                            <h6 style="color:#000"> Master Construction Cost Management with the Quantity Survey
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="row intro">
                        <div class="col-12 p-0">
                            <h3 class="featured alt">
                                What You Will Achieve from the Quantity Survey Engineering
                                Program
                            </h3>
                            <p style="text-align: justify">
                                The goal of the online quantity survey engineering program is
                                to provide future professionals with the knowledge and
                                abilities necessary to handle construction projects' budgets,
                                agreements, and sustainability. Highly sought-after skills
                                including resource allocation, construction economics, and
                                project estimation are developed by this training program.
                                This curriculum equips you to manage every stage of a
                                construction project, from initial feasibility to final cost
                                management, with professionalism and confidence, regardless of
                                whether you are new to the field or looking to expand your
                                skill set.
                            </p>
                ...
                <div class="col-12 col-md-6">
                    <a href="">
                        <img src="/frontend/assets/images/quantity-surveying-engineering-program-1.jpg" class="fit-image"
                            alt="Quantity Surveying Program" />
                    </a>
                </div>
            </div>
        </div>
            ...
            <div id="section1" class="content-section" style="padding: 10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <p>
                            This curriculum covers the essential areas needed to support
                            effective and economical construction project management, giving
                            students a strong foundation in quantity surveying. It is
                            appropriate for both beginners and experts wishing to expand
                            their understanding of building cost management as it combines
            ...
            <div id="section2" class="content-section" style="padding: 10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <ul>
                            <li>
                                To train professionals in precise cost estimation and budget
                                control.
                            </li>
                            <li>
                                To equip learners with knowledge of legal and contractual obligations.
                            </li>
                            <li>
                                To develop expertise in managing resources and project timelines.
                            </li>
                            <li>
                                To evaluate the economic feasibility and sustainability of construction projects.
                            </li>
                            <li>
                                To promote innovative practices in modern cost and resource management.
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div id="section3" class="content-section" style="padding: 10px 0px">
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Module 1: Introduction to Quantity Surveying</td>
                                        <td>4 Hours</td>
                                        <td>Overview of the role and responsibilities of a quantity surveyor in construction
                                            projects.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 2: Measurement and Estimation</td>
                                        <td>6 Hours</td>
                                        <td>Fundamentals of taking off quantities and estimating construction costs.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 3: Construction Cost Management</td>
                                        <td>6 Hours</td>
                                        <td>Principles of budgeting, cost planning, and cost control in construction
                                            projects.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 4: Contract Administration and Law</td>
                                        <td>6 Hours</td>
                                        <td>Understanding construction contracts, legal aspects, and contract management.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 5: Tendering and Procurement</td>
                                        <td>6 Hours</td>
                                        <td>
                                            The process of preparing tender documents, evaluating bids, and procurement.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 6: P Project Risk Management</td>
                                        <td>6 Hours</td>
                                        <td>
                                            Risk management techniques to assess and mitigate project risks.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 7: Construction Project Planning and Scheduling</td>
                                        <td>6 Hours</td>
                                        <td>
                                            Techniques for effective planning and scheduling of construction projects.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 8: Building Services and Sustainability</td>
                                        <td>4 Hours</td>
                                        <td>
                                            Understanding the role of building services and sustainable practices in
                                            construction..
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 9: Final Account Preparation and Valuation</td>
                                        <td>4 Hours</td>
                                        <td>
                                            Procedures for preparing final accounts and resolving disputes in construction
                                            projects.
                                        </td>
                                    </tr>
                                </tbody>
            ...
            <div id="section4" class="content-section" style="padding: 10px 0px">
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Quantity Survey Engineering Program </td>
                                        <td>100% Online</td>
                    ...
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul>
                                    <li>
                                        Ability to estimate, budget, and control costs across all construction phases.
                                    </li>
                                    <li>
                                        Skills in contract management, legal compliance, and project documentation.
                                    </li>
                                    <li>
                                        Proficiency in planning and scheduling construction activities effectively.
                                    </li>
                                    <li>
                                        Competence in applying sustainable principles in construction designs and processes.
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Cost Estimation & Budgeting</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Measurement and Quantity</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Contract Management</span>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Project Management & Planning</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Construction Technology Knowledge</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Sustainability and Green Building Costing</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="features" class="section-2 odd offers" style="padding: 40px 0 !important">
        <div class="container">
            <h3 class="text-center">
                Why Choose ASTI Online for Quantity Survey Engineering ?
            </h3>
            <div class="row justify-content-center text-center items">
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        <i class="icon icon-globe"></i>
                        <h4>Globally Recognized Curriculum</h4>
                        <p>
                            Aligned with current construction and engineering standards.
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <h4>Flexible Online Delivery</h4>
                        <p>
                            Study from anywhere, anytime, while balancing work and life.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Focus on practical, job-ready skills that employers seek.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <h4>Expert Faculty & Support </h4>
                        <p>Learn from experienced professionals and receive personalized mentorship. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="section8" class="section-6 subscribe" style="padding: 20px 0px">
        <div class="container smaller">
            ...
            <div class="faq-container">
                <div class="faq">
                    <h5 class="faq-title">What is Quantity Surveying?</h5>
                    <p class="faq-text">
                        It involves managing costs, contracts, and resources in construction projects to ensure value for
                        money.
                    </p>
                ...
                <div class="faq">
                    ...
                    <p class="faq-text">
                        Yes. It is designed for both beginners and working professionals seeking formal training.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                ...
                <div class="faq">
                    <h5 class="faq-title">
                        What career opportunities will I have after completing this course?
                    </h5>
                    <p class="faq-text">
                        Graduates can pursue roles such as Quantity Surveyor, Estimator, Project Coordinator, or Cost
                        Engineer.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                ...
                <div class="faq">
                    ...
                    <p class="faq-text">
                        Yes, the program is delivered 100% online, allowing flexible learning from anywhere.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                ...
                <div class="faq">
                    <h5 class="faq-title">What are the entry requirements?</h5>
                    <p class="faq-text">
                        Applicants should have a foundation-level diploma or relevant experience in construction or
                        engineering. Yes, we offer Online Oracle Financials courses with flexible
                        learning options.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                ...
                <div class="faq">
                    ...
                    <p class="faq-text">
                        Assessments include hands-on practicals, case studies, and oral presentations.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
    ...
    <!-- Features -->
    <section id="why-quantity" class="why-section">
        <div class="container">
            <div class="why-header">
                <h3>What are 4 reasons to study Quantity Surveying?</h3>
            </div>
            ...
            <div class="why-grid">
                <div class="why-card">
                    ...
                    <p>
                        Quantity Surveyors play a critical role in every construction
                ...
                <div class="why-card">
                    <i class="icon icon-basket"></i>
                    <h4>Sustainable Career Growth</h4>
                    <p>
                        Open doors to senior roles in construction, consultancy,
                ...
                <div class="why-card">
                    ...
                    <p>
                        Learn practical skills that can be applied immediately
                ...
                <div class="why-card">
                    <i class="icon icon-layers"></i>
                    <h4>Flexible & Affordable</h4>
                    <p>
                        Study at your own pace without compromising your
                        current job or commitments.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    ...
                                    <h4>Rina Shine</h4>
                                    <p style="text-align: justify">
                                        The modules are hands-on and tailored to the real challenges in today’s construction
                                        world.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    ...
                                    <h4> Mohamed K.</h4>
                                    <p style="text-align: justify">
                                        I was looking for a flexible course to strengthen my cost management skills—the
                                        online program delivered beyond expectations.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row card">
                                <div class="col-12">
                                    <img src="/frontend/assets/images/testimonial/19.webp" alt="Nadia Malik"
                                        class="person" />
                                    <h4> Fatima Mariyam</h4>
                                    <p style="text-align: justify">
                                        As a working professional, the online format helped me learn without taking a break
                                        from my job.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    ...
                                    <h4>Abdul</h4>
                                    <p style="text-align: justify">
                                        I had no experience in QS, but this course gave me everything I needed to start my
                                        career.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    ...
                                    <h4>Rachel</h4>
                                    <p style="text-align: justify">
                                        The mentors were experienced and always ready to guide us through every module.
                                    </p>
                                </div>
                            </div>
                        </div>
