        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-left">
                    ...
                    <h1 class="hero-title">
                        Master <span class="gradient-text">Cyber Security</span> with
                        Hands-On Offline Training
                    </h1>
                    <p class="hero-subtitle">
                        Join our intensive Cyber security program with expert mentors, real-time projects, and
                        classroom-based sessions. Build industry-ready skills in network security, ethical hacking, cloud
                        security, and cyber defence with personalized mentor guidance.
                    </p>
    ...
    <section id="why-course" class="why-course-section">
        <div class="container">
            <div class="section-header">
                <h2>Why Choose Cyber security Offline Training? </h2>
                <p>
    ...
    <section id="course-highlightss" class="course-curriculum">
        ...
        <div class="accordion">
            ...
            <div class="accordion-item">
                <button class="accordion-header">Cyber Security & Ethical Hacking Foundation</button>
                <div class="accordion-content">
                    <ul>
                        <li>Overview of Ethical Hacking</li>
                        <li>Basic Hacking Concepts</li>
                        <li>Principles of Ethical Hacking</li>
                        <li>White Hat vs Black Hat Practices</li>
                        <li>Introduction to Information Security</li>
                        <li>Understanding the Cyber Kill Chain</li>
                        <li>Security Controls in Information Systems</li>
                        <li>Regulations, Laws, and Standards in Cybersecurity</li>
                        <li>Network Scanning Techniques</li>
                        <li>Enumeration Fundamentals</li>
                        <li>Performing Vulnerability Analysis</li>
                        <li>System Hacking Approaches</li>
                        <li>Understanding Malware Threats</li>
                        <li>Packet Sniffing</li>
                        <li>Social Engineering Attacks</li>
                        <li>Denial-of-Service Attacks</li>
                        <li>Session Hijacking Methods</li>
                        <li>Bypassing IDS, Firewalls, and Honeypots</li>
                        <li>Exploiting Web Servers</li>
                        <li>Web Application Attacks</li>
                        <li>SQL Injection Techniques</li>
                        <li>Wireless Network Exploitation</li>
                        <li>Using Kali Linux & Parrot OS</li>
                        <li>Tools: OpenVAS, Metasploit, Nmap, Maltego, Netsparker</li>
                        <li>Tools: Wireshark, John the Ripper, Angry IP Scanner, Cain, Nikto</li>
                        <li>Hands-on Vulnerability Exploitation</li>
                        <li>Introduction to Penetration Testing</li>
                        <li>Privilege Escalation Methods</li>
                        <li>Responsible Vulnerability Reporting</li>
                        <li>OSI & TCP Model Basics</li>
                        <li>Comparison of OSI vs TCP/IP</li>
                        <li>Understanding TCP, UDP, and IP Protocols</li>
                        <li>Cyber Attacks across OSI Layers</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Module 2 -->
            <div class="accordion-item">
                <button class="accordion-header">Cyber Security Professional Level</button>
                <div class="accordion-content">
                    <ul>
                        <li>Introduction to Advanced Cyber Security & Hacking</li>
                        <li>Kali Linux Installation and Setup</li>
                        <li>Linux Commands Practice</li>
                        <li>Footprinting Concepts & Techniques</li>
                        <li>Footprinting via Search Engines, Web, and Social Media</li>
                        <li>Website & Email Footprinting</li>
                        <li>Whois & DNS Footprinting</li>
                        <li>Social Engineering Footprinting</li>
                        <li>Popular Footprinting Tools & Countermeasures</li>
                        <li>Network Scanning Fundamentals</li>
                        <li>Host Discovery, Port & Service Scanning</li>
                        <li>Operating System Fingerprinting</li>
                        <li>Bypassing Firewalls/IDS in Scanning</li>
                        <li>Creating Network Diagrams</li>
                        <li>Enumeration Methods (NetBIOS, SNMP, LDAP, NTP, SMTP, DNS)</li>
                        <li>Countermeasures against Enumeration</li>
                        <li>Vulnerability Assessment Overview</li>
                        <li>Classification & Assessment Methodologies</li>
                        <li>Assessment Tools & Reporting</li>
                        <li>System Hacking (Access, Privilege Escalation, Maintaining Access)</li>
                        <li>Image Steganography</li>
                        <li>Log Clearing Techniques</li>
                        <li>Malware & APT Concepts</li>
                        <li>Viruses, Worms & Fileless Malware</li>
                        <li>Malware Analysis & Countermeasures</li>
                        <li>Sniffing Techniques (MAC, DHCP, ARP Poisoning, DNS Poisoning)</li>
                        <li>Sniffing Tools & Detection Methods</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Module 3 -->
            <div class="accordion-item">
                <button class="accordion-header">Cyber Security Professional Level 2</button>
                <div class="accordion-content">
                    <ul>
                        <li>Social Engineering Attacks & Countermeasures</li>
                        <li>Insider Threats & Identity Theft</li>
                        <li>DDoS & DoS Concepts and Techniques</li>
                        <li>Botnets & Case Studies</li>
                        <li>DDoS Attack Tools & Protection Mechanisms</li>
                        <li>Session Hijacking (Application & Network Level)</li>
                        <li>Hijacking Tools & Countermeasures</li>
                        <li>IDS, IPS, Firewalls, and Honeypots Overview</li>
                        <li>Bypassing IDS/Firewalls & Detection Techniques</li>
                        <li>Web Server Attacks & Patch Management</li>
                        <li>Web Server Security Tools</li>
                        <li>Web Application Threats & Hacking Methods</li>
                        <li>SQL Injection Techniques & Tools</li>
                        <li>Web Application Security Practices</li>
                        <li>Wireless Networks: Threats, Tools & Countermeasures</li>
                        <li>Mobile Security (Android & iOS Exploits)</li>
                        <li>Cloud Computing Threats & Security</li>
                        <li>Cryptography & PKI Concepts</li>
                        <li>Email & Disk Encryption</li>
                        <li>IoT Hacking (Attacks, Tools & Mitigation)</li>
                        <li>OT Hacking (Methods & Security Tools)</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Module 4 -->
            <div class="accordion-item">
                <button class="accordion-header">Penetration Testing</button>
                <div class="accordion-content">
                    <ul>
                        <li>Introduction to Penetration Testing</li>
                        <li>Benefits and Applications</li>
                        <li>Types of Pen Testing</li>
                        <li>Phases and Methodologies</li>
                        <li>Best Practices & Guidelines</li>
                        <li>Risk Assessment in Pen Testing</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Module 5 -->
            <div class="accordion-item">
                <button class="accordion-header">AI in Cyber Security</button>
                <div class="accordion-content">
                    <ul>
                        <li>Basics of AI & Machine Learning</li>
                        <li>AI Algorithms, Models & Frameworks</li>
                        <li>Neural Networks & Deep Learning</li>
                        <li>Data Processing & Anomaly Detection</li>
                        <li>AI in Intrusion Detection & Malware Analysis</li>
                        <li>AI for Threat Prediction & Network Traffic Monitoring</li>
                        <li>AI in Automated Incident Response</li>
                        <li>AI-based Antivirus & Endpoint Protection</li>
                        <li>AI in Phishing Detection</li>
                        <li>Ethical Concerns, Privacy & Legal Standards</li>
                        <li>AI for Blockchain Security</li>
                        <li>AI with Quantum Computing & IoT</li>
                        <li>Future of AI in Cyber Defense</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Module 6 -->
            <div class="accordion-item">
                <button class="accordion-header">System Hacking</button>
                <div class="accordion-content">
                    <ul>
                        <li>Core System Hacking Concepts</li>
                        <li>Access Gaining Techniques</li>
                        <li>Privilege Escalation</li>
                        <li>Maintaining System Access</li>
                        <li>Using Steganography Tools</li>
                        <li>Log Clearing for Covering Tracks</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Module 8 -->
            <div class="accordion-item">
                <button class="accordion-header">Sniffing</button>
                <div class="accordion-content">
                    <ul>
                        <li>Sniffing Fundamentals</li>
                        <li>MAC Flooding Attacks</li>
                        <li>DHCP Attacks</li>
                        <li>ARP Poisoning</li>
                        <li>IP/DNS Spoofing Attacks</li>
                        <li>DNS Poisoning</li>
                        <li>Sniffing Tools Overview</li>
                        <li>Countermeasures & Detection</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Module 9 -->
            <div class="accordion-item">
                <button class="accordion-header">Social Engineering</button>
                <div class="accordion-content">
                    <ul>
                        <li>Introduction to Social Engineering</li>
                        <li>Popular Attack Techniques</li>
                        <li>Insider Threats in Organizations</li>
                        <li>Identity Theft Scenarios</li>
                        <li>Impersonation on Social Platforms</li>
                        <li>Defensive Strategies & Countermeasures</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Module 10 -->
            <div class="accordion-item">
                <button class="accordion-header">Denial-of-Service (DoS & DDoS)</button>
                <div class="accordion-content">
                    <ul>
                        <li>Basics of DoS & DDoS Attacks</li>
                        <li>Common Attack Techniques</li>
                        <li>Botnets and Their Role</li>
                        <li>DDoS Case Studies</li>
                        <li>Attack Tools Overview</li>
                        <li>Protection Mechanisms</li>
                        <li>DDoS Defense Tools</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="comparison-card offline">
                    ...
                    <div class="benefits-list">
                        <div class="benefit">
                            ...
                            <span>Face-to-face interaction with cyber security experts</span>
                        </div>
                        <div class="benefit">
                            <i class="fas fa-check"></i>
    ...
    <section id="target-audience" class="target-audience-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Perfect for anyone looking to excel in cyber security.</p>
            </div>
    ...
    <section id="testimonials" class="testimonials-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Success stories from our Cyber Security Graduates</p>
            </div>
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        “The hands-on Cybersecurity projects boosted my confidence. I got placed as a Security Analyst
                        within 3 months.”
                    </p>
                </div>
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        ...
                        <div class="student-info">
                            <h4>Megha Rao </h4>
                            <p>Cyber Security Strategist at Zomato</p>
                            <div class="rating">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <p class="testimonial-text">
                        “Coming from a non-tech background, the mentor guidance helped me switch my career into
                        Cybersecurity smoothly.”
                    </p>
                </div>
                <div class="testimonial-card">
                    <div class="testimonial-header">
                    ...
                    <p class="testimonial-text">
                        “Practical training on ethical hacking and defense tools was the highlight. I now work as a
            ...
            <div class="faq-container">
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Yes, our Cybersecurity certification is globally recognized and highly valued by top IT
                            companies.
                        </p>
                    </div>
                </div>
    ...
    <section id="final-cta" class="final-cta-section">
        <div class="container">
            <div class="cta-content">
                ...
                <p>
                    Join thousands of students who choose offline Cyber Security training for accelerated learning
                </p>
                <div class="cta-stats">
                    <div class="stat">
                        <h3>10,000+</h3>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    ...
                    <p>
                        Transforming IT & security careers through hands-on Cybersecurity training. Gain expertise in
                        ethical hacking, network defense, cloud security, and more with industry-certified mentors in
                        Hyderabad.
                    </p>
