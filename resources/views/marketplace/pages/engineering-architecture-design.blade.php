...
@section('content')
    ...
    <section class="category-section">
        <h2 class="category-title">Engineering Architecture & Design</h2>
        ...
        <div class="grid-container">
            ...
            <div class="course-card">
                ...
                <div class="course-content">
                    <div class="course-name">Petroleum Engineering Programee</div>
                    <div class="course-info pricing">Price: $599</div>
                    <div class="course-info">Duration: 6 Months</div>
            ...
            <div class="course-card">
                ...
                <div class="course-content">
                    <div class="course-name">Electrical Vehicle Engineerin Course</div>
                    <div class="course-info pricing">Price: $599</div>
                    <div class="course-info">Duration: 6 Months</div>
            ...
            <div class="course-card">
                <img src="/frontend/assets/images/facade-engineering.jpg" alt="Electrical Vehicle Engineering Course" />
                <div class="course-content">
