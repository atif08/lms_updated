...
@section('content')
    <section class="category-section">
        ...
        <div class="grid-container">
            ...
            {{-- <div class="course-card">
                <img src="/frontend/assets/images/digital-marketing.jpg" alt="Oracle Financial" />
                <div class="course-content">
                    <div class="course-name">Digital Marketing With AI</div>
                    <div class="course-info pricing">Price: $599</div>
                    <div class="course-info">Duration: 6 Months</div>
                    <a href="/courses/best-digital-marketing-course-in-hyderabad" class="enroll-btn">Read More</a>
                </div>
            </div> --}}

            {{-- <div class="course-card">
                <img src="/frontend/assets/images/cyber-security.jpg" alt="Oracle Financial" />
                <div class="course-content">
                    <div class="course-name">Cyber Security With AI</div>
                    <div class="course-info pricing">Price: $599</div>
                    <div class="course-info">Duration: 6 Months</div>
                    <a href="/courses/best-cyber-security-course-in-hyderabad" class="enroll-btn">Read More</a>
                </div>
            </div> --}}
            ...
            <div class="course-card">
                <img src="/frontend/assets/images/project-manag.avif" alt="Marketing Management & Sales" />
                <div class="course-content">
