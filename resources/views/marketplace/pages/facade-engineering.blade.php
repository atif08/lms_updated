...
@section('content')
                ...
                <div class="swiper-slide slide-center">
                    ...
                    <div class="slide-content row text-center">
                        <div class="col-12 mx-auto inner">
                            ...
                            <h6 style="color:#000"> Advance Your Expertise in Modern Building Design with Cutting-Edge
                                Facade Engineering
                            </h6>
                        </div>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="row intro">
                        <div class="col-12 p-0">
                            <h3 class="featured alt">
                                What You Will Achieve from the Online Façade Engineering Program
                            </h3>
                            <p style="text-align: justify">
                                The Online Façade Engineering Diploma Program equips you with a solid foundation in façade
                                materials, structural principles, thermal and acoustic performance, and modern façade
                                systems. You will learn the complete façade design and integration process, along with
                                essential skills in glass façade engineering, cladding, project management, and system
                                inspection.

                                By completing this program, you will be prepared to design, evaluate, and manage
                                high-performance façade solutions for roles in architecture, construction, and engineering
                                consultancy.
                            </p>
                ...
                <div class="col-12 col-md-6">
                    <a href="#">
                        <img src="/frontend/assets/images/facade-engineering.jpg" class="fit-image"
            ...
            <div id="section1" class="content-section" style="padding: 10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <p>
                            The Online Façade Engineering Diploma Program offers a practical introduction to modern façade
                            systems, covering materials, structural principles, thermal and acoustic performance, and design
                            integration. You will also learn essential concepts in glass façades, cladding systems, and
                            project management, along with testing and maintenance practices. This program prepares you to
                            support the design and delivery of high-performance building façades in architectural and
            ...
            <div id="section2" class="content-section" style="padding: 10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <ul>
                            <li>
                                To build a strong understanding of façade materials, structural principles, and building
                                envelope performance
                            </li>
                            <li>
                                To develop competencies in façade design integration, including thermal, acoustic, and
                                environmental considerations
                            </li>
                            <li>
                                To explore advanced façade systems such as glass façades, cladding, and ventilated façade
                                technologies
                            </li>
                            <li>
                                To equip learners with practical skills in façade project management, testing, inspection,
                                and maintenance
                            </li>
                        </ul>
                    </div>
            ...
            <div id="section3" class="content-section" style="padding: 10px 0px">
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Introduction to Façades</td>
                                        <td>4 Hours</td>
                                        <td>A brief overview of façade engineering, its purpose, components, and role in
                                            modern buildings.</td>
                                    </tr>
                                    <tr>
                                        <td>Materials for Façades</td>
                                        <td>6 Hours</td>
                                        <td>Covers key façade materials, their properties, performance, and selection
                                            criteria.</td>
                                    </tr>
                                    <tr>
                                        <td>Structural Principles and Systems</td>
                                        <td>6 Hours</td>
                                        <td>Explores load behavior, structural design concepts, and support systems for
                                            façades.</td>
                                    </tr>
                                    <tr>
                                        <td>Thermal, Acoustic, and Environmental Performance</td>
                                        <td>6 Hours</td>
                                        <td>Focuses on energy efficiency, sound control, and environmental factors impacting
                                            façade performance.</td>
                                    </tr>
                                    <tr>
                                        <td>Façade Design Process and Integration</td>
                                        <td>6 Hours</td>
                                        <td>Introduces end-to-end façade design workflow and coordination with architectural
                                            and MEP systems.</td>
                                    </tr>
                                    <tr>
                                        <td>Glass Façade Design</td>
                                        <td>4 Hours</td>
                                        <td>Examines glass types, performance characteristics, and safe design
                                            considerations for glass façades.</td>
                                    </tr>
                                    <tr>
                                        <td>Cladding and Ventilated Façades</td>
                                        <td>4 Hours</td>
                                        <td>Provides insight into cladding systems, ventilated façades, and their
                                            installation methods.</td>
                                    </tr>
                                    <tr>
                                        <td>Façade Project Management</td>
                                        <td>4 Hours</td>
                                        <td>Covers planning, scheduling, budgeting, and risk management in façade projects.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Façade Testing, Inspection, and Maintenance</td>
                                        <td>4 Hours</td>
                                        <td>Explains façade testing standards, inspection procedures, and long-term
                                            maintenance practices.</td>
                                    </tr>
                                    <tr>
                                        <td>Façade Trends and Innovations</td>
                                        <td>4 Hours</td>
                                        <td>Highlights emerging technologies, sustainable solutions, and future advancements
                                            in façade engineering.
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <div id="section4" class="content-section" style="padding: 10px 0px">
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Facade Engineering Program</td>
                                        <td>100% Online</td>
                    ...
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul>
                                    <li>
                                        Understand the core principles of façade materials, structural behavior, and
                                        building envelope performance
                                    </li>
                                    <li>
                                        Analyze and apply façade design methods considering thermal, acoustic, and
                                        environmental requirements
                                    </li>
                                    <li>
                                        Develop skills in glass façade design, cladding systems, and modern ventilated
                                        façade technologies
                                    </li>
                                    <li>
                                        Gain practical competency in façade project management, testing, inspection, and
                            ...
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Façade Materials Selection & Performance Analysis</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Structural Behavior and Load Assessment for Building
                                        Envelopes</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Thermal, Acoustic, and Environmental Performance
                                        Optimization</span>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Glass Façade Engineering & Safety Design
                                        Principles</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Cladding Systems, Ventilated Façades & Installation
                                        Techniques</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Façade Design Integration with Architectural and MEP
                                        Systems</span>
                                </div>
                            </div>
                        </div>
    ...
    <section id="features" class="section-2 odd offers" style="padding: 40px 0 !important">
        <div class="container">
            <h3 class="text-center">
                Why Choose ASTI Online for Facade Engineering Program ?
            </h3>
            <div class="row justify-content-center text-center items">
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Work with real-world façade systems, materials, and performance evaluation techniques.
        ...
        <div class="container smaller">
            ...
            <div class="faq-container">
                <div class="faq">
                    ...
                    <p class="faq-text">
                        This program provides a comprehensive understanding of façade materials, structural systems, thermal
                        and acoustic performance, and the complete façade design and integration process used in modern
                        buildings.
                    </p>
                ...
                <div class="faq">
                    ...
                    <p class="faq-text">
                        No prior experience is required. The program starts with foundational concepts and gradually
                        introduces advanced façade engineering principles suitable for beginners and professionals.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                ...
                <div class="faq">
                    ...
                    <p class="faq-text">
                        Graduates can pursue roles such as Façade Engineer, Façade Designer, Building Envelope Specialist,
                        Cladding Engineer, Façade Project Coordinator, and Quality/Inspection Engineer in architecture,
                ...
                <div class="faq">
                    ...
                    <p class="faq-text">
                        Yes, learners receive a recognized certification upon successful completion of all modules and
                        assessments.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                ...
                <div class="faq">
                    ...
                    <p class="faq-text">
                        Yes, the entire program is delivered online, allowing you to learn at your own pace from any
                        location.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                ...
                <div class="faq">
                    ...
                    <p class="faq-text">
                        You will gain exposure to industry-relevant façade analysis and drafting tools, including CAD
                        platforms and performance evaluation methods used for thermal, structural, and material assessments.
                    </p>
                    <button class="faq-toggle">
                        <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
    ...
    <!-- Features -->
    <section id="why-facade-engineering" class="why-section">
        <div class="container">
            <div class="why-header">
                <h3>
                    What are the 4 reasons to study the Online Façade Engineering Program?
                </h3>
            </div>
            ...
            <div class="why-grid">
                <div class="why-card">
                    ...
                    <p>
                        Modern buildings require skilled façade engineering
                        professionals, creating strong global career opportunities.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <p>
                        Gain hands-on exposure to real façade systems, materials,
                ...
                <div class="why-card">
                    ...
                    <p>
                        Study at your own pace through an online program designed
                ...
                <div class="why-card">
                    <i class="icon icon-layers"></i>
                    <h4>Opportunities Across Architecture & Construction</h4>
                    <p>
                        Façade engineering skills are essential in architecture,
                        structural design, sustainability, and building project
                        management.
                    </p>
                </div>
            </div>
