...
@section('content')
                    ...
                    <div class="slide-content row text-center">
                        <div class="col-12 mx-auto inner">
                            <h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text"
                                ...
                                Level 5 Diploma in Business Management Course
                            </h1>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="row intro">
                        <div class="col-12 p-0">
                            <h3 class="featured alt">
                                How Does Level 5 Diploma in Business Management Strengthen My Professional Foundation?
                            </h3>
                            <p style="text-align: justify">
                                The Level 5 Diploma in Business Management equips you with advanced academic knowledge and
                                practical management skills required to perform effectively in mid-level managerial and
                                strategic roles. The programme builds on foundational business concepts and focuses on
                                developing a deeper understanding of strategy, human resource management, marketing,
                                business law, management accounting, and entrepreneurship.

                                Through structured learning and real-world business scenarios, you will strengthen your
                                ability to analyze complex business situations, make informed decisions, and apply strategic
                                thinking within organizational contexts. The course enhances critical skills such as
                                leadership, problem-solving, financial analysis, and people management, enabling you to
                                manage teams, resources, and business operations more effectively.

                                By the end of the programme, you will have a strong professional foundation to progress into
                                senior business roles, pursue entrepreneurial ventures, or advance to higher-level academic
                                qualifications. This diploma prepares you to operate confidently in dynamic, competitive,
                                and global business environments with professionalism and strategic insight.
                            </p>
                ...
                <div class="col-12 col-md-6">
                    <a href="#">
                        <img src="/frontend/assets/images/level-5-business-management.jpg" class="fit-image"
            ...
            <div id="section1" class="content-section" style="padding: 10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <p>
                            The OTHM Level 5 Diploma in Business Management is designed to develop advanced business and
                            management skills required for today’s competitive and dynamic business environment. The
                            programme focuses on strategic thinking, leadership, marketing, human resource management,
                            business law, and financial decision-making. It prepares learners to handle complex business
                            challenges, progress into managerial roles, or advance to higher-level academic qualifications
            ...
            <div id="section2" class="content-section" style="padding: 10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <ul>
                            <li>
                                <b>Develop Strategic Management Knowledge:</b> Build a strong understanding of business
                                strategy, strategic analysis, and decision-making frameworks used in modern organizations.
                            </li>

                            <li>
                                <b>Strengthen Leadership and Human Resource Skills:</b> Enhance the ability to manage
                                people, lead teams, and apply effective human resource management practices in diverse
                                business environments.
                            </li>

                            <li>
                                <b>Apply Marketing, Legal, and Financial Principles:</b> Gain practical knowledge of
                                marketing strategies, business law, and management accounting to support informed business
                                decisions.
                            </li>

                            <li>
                                <b>Encourage Entrepreneurial and Business Growth Skills:</b> Develop the skills required to
                                plan, launch, and manage business start-ups while supporting organizational growth and
                                sustainability.
                            </li>
            ...
            <div id="section3" class="content-section" style="padding: 10px 0px">
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Unit 1: Principles and Concepts of Strategy</td>
                                        <td>200 Hours</td>
                                        <td>Understand strategic planning, analysis, and implementation within
                                            organizations.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Unit 2: The Management of Human Resources</td>
                                        <td>200 Hours</td>
                                        <td>Develop skills to manage people, performance, and organizational culture
                                            effectively.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Unit 3: Marketing for Managers</td>
                                        <td>200 Hours</td>
                                        <td>Learn marketing concepts, strategies, and decision-making for business growth.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Unit 4: Business Law for Managers</td>
                                        <td>200 Hours</td>
                                        <td>Gain knowledge of legal principles affecting business operations and management
                                            decisions.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Unit 5: Management Accounting and Decision Making</td>
                                        <td>200 Hours</td>
                                        <td>Apply financial and accounting information to support managerial
                                            decision-making.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Unit 6: Business Start-up: Conception to Market</td>
                                        <td>200 Hours</td>
                                        <td>Learn how to plan, launch, and manage a business from idea to market entry.
                                        </td>
                                    </tr>
            ...
            <div id="section4" class="content-section" style="padding: 10px 0px">
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Level-5 Diploma In Business Management</td>
                                        <td>100% Online</td>
                    ...
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul>
                                    <li>
                                        Understand strategic management concepts and apply strategic thinking to real-world
                                        business scenarios.
                                    </li>
                                    <li>
                                        Apply effective leadership and human resource management practices within
                                        organizational settings.
                                    </li>
                                    <li>
                                        Analyze marketing, legal, and financial information to support informed business
                                        decision-making.
                                    </li>
                                    <li>
                                        Demonstrate entrepreneurial skills by planning, evaluating, and launching business
                            ...
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Strategic planning and analysis</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Leadership and people management</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Marketing strategy development</span>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Business law and compliance awareness</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Management accounting and financial analysis</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Entrepreneurship and business start-up planning</span>
                                </div>
                            </div>
                        </div>
    ...
    <section id="features" class="section-2 odd offers" style="padding: 40px 0 !important">
        <div class="container">
            <h3 class="text-center">
                Why Choose ASTI Online for Level 5 Diploma in Business Management?
            </h3>
            <div class="row justify-content-center text-center items">
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            ...
                            covering strategy, human resources, marketing, finance, business law, and global business
                            practices.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Prepare for entry-level to mid-level management roles, career progression, or further academic
                            study with skills that enhance employability and professional growth across industries.
                        </p>
                    </div>
                </div>
        ...
        <div class="container smaller">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="faq-container col-12">
                    <div class="faq">
                        <h5 class="faq-title">Who can enroll in the OTHM Level 5 Diploma in Business Management?</h5>
                        <p class="faq-text">
                            This programme is suitable for learners who have completed a Level 4 qualification or equivalent
                            and wish to advance their knowledge and skills in business and management. It is also ideal for
                            working professionals seeking career progression.
                        </p>
                    ...
                    <div class="faq">
                        <h5 class="faq-title">Do I need prior business or management experience to join this programme?
                        </h5>
                        <p class="faq-text">
                            Prior business experience is not mandatory; however, a basic understanding of business concepts
                            or completion of a Level 4 qualification is recommended to successfully engage with the course
                            content.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <div class="faq">
                        <h5 class="faq-title">
                            Is the OTHM Level 5 Diploma internationally recognized?
                        </h5>
                        <p class="faq-text">
                            Yes. The OTHM Level 5 Diploma in Business Management is an internationally recognized
                            qualification, enabling learners to progress to higher education or career opportunities
                            globally.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <div class="faq">
                        <h5 class="faq-title">How is the programme assessed and are there any examinations?</h5>
                        <p class="faq-text">
                            The programme is assessed through assignment-based evaluations, including written assignments
                            and case studies. There are no written examinations for this qualification.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                    ...
                    <div class="faq">
                        <h5 class="faq-title">
                            Will I receive a certificate after completing the Level 5 Diploma?
                        </h5>
                        <p class="faq-text">
                            Yes. Learners who successfully complete all required units and assessments will receive the OTHM
                            Level 5 Diploma in Business Management certificate.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                    ...
                    <div class="faq">
                        <h5 class="faq-title">What career or academic progression options are available after completing
                            this qualification?
                        </h5>
                        <p class="faq-text">
                            Graduates can progress to OTHM Level 6 qualifications, undergraduate degree programmes, or
                            pursue mid-level management roles in areas such as operations, marketing, human resources, and
    ...
    <!-- Features -->
    <section id="why-level-5-business-management" class="why-section">
        <div class="container">
            <div class="why-header">
                <h3>What are the 4 reasons to study the Level 5 Diploma in Business Management?</h3>
            </div>

            <div class="why-grid">
                <div class="why-card">
                    <i class="icon icon-globe"></i>
                    <h4>Growing Demand Across Industries</h4>
                    <p>
                        Business management professionals are in demand across
                        finance, retail, healthcare, technology, and operations,
                        helping organizations improve efficiency and drive growth.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <p>
                        This programme prepares learners for modern, technology-enabled
                        management roles that rely on digital tools, data analysis,
                ...
                <div class="why-card">
                    ...
                    <p>
                        Learn through real-world business scenarios, case studies,
                        and assignments that develop leadership, finance,
                        communication, and operations skills.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <p>
                        Progress into entry-level and mid-level management roles,
                        supervisory positions, or higher academic qualifications
