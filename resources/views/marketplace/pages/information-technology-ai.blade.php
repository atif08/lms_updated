...
@section('content')
    ...
    <section class="category-section">
        <h2 class="category-title">Information Technology & AI Courses</h2>

        <div class="grid-container">
            <div class="course-card">
                <img src="/frontend/assets/images/data-analysis-training-course-1.jpg" alt="Data Analysis Training Course" />
                <div class="course-content">
                    <div class="course-name">Data Analysis Taining Course</div>
            ...
            <div class="course-card">
                ...
                <div class="course-content">
                    ...
                    <div class="course-info pricing">Price: $599</div>
                    <div class="course-info">Duration: 6 Months</div>
                    <a href="study-artificial-intelligence-diploma-program.html" class="enroll-btn">Read More</a>
                </div>
            </div>

            <div class="course-card">
                <img src="/frontend/assets/images/digital-marketing-management.jpg" alt="Blockchain Technology Programme" />
                <div class="course-content">
                    <div class="course-name">Digital Marketing Management</div>
                    <div class="course-info pricing">Price: $599</div>
                    <div class="course-info">Duration: 6 Months</div>
                    <a href="/courses/digital-marketing-management" class="enroll-btn">Read
                        More</a>
                </div>
            </div>
            ...
            <div class="course-card">
                <img src="/frontend/assets/images/health-administration.jpg" alt="Artificial Intelligence Programme" />
                <div class="course-content">
