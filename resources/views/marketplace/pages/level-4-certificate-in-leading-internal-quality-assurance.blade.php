...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="social-button">
      ...
      <button class="btn sixthbtn">Apply Now</button>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="row intro">
              <div class="col-12 p-0">
                <h3 class="featured alt">
                  Certificate In Leading The Internal Quality Assurance Of
                  Assessment Processes AND Practice
                </h3>
                <p>
                  The aim of this unit is to develop learners' ability to
                  understand and apply the context, principles, planning, and
                  maintenance aspects of internal quality assurance in
                  assessment. By the end of this learning process, learners
                  should be able to comprehend the context and principles that
                  underpin internal quality assurance, demonstrate knowledge of
                  planning internal quality assurance activities, and understand
                  how to effectively maintain and improve the quality of
          ...
          <div class="col-12 col-md-6">
            <a href="assets/images/foundation.webp">
              <img
                src="assets/images/foundation.webp"
                class="fit-image"
                alt="About Us"
              />
            </a>
          ...
          <div class="row">
            <div class="col-12 col-md-12 text-md-left mt-5">
              ...
              <p>
                The aim of this unit is to develop learners' ability to
                understand and apply the context, principles, planning, and
                maintenance aspects of internal quality assurance in assessment.
              </p>
              <p>
                By the end of this learning process, learners should be able to
                comprehend the context and principles that underpin internal
                quality assurance, demonstrate knowledge of planning internal
                quality assurance activities, and understand how to effectively
                maintain and improve the quality of assessment internally.
              </p>
            </div>
          </div>
        </div>
        ...
        <div id="section2" class="content-section">
          <div class="row">
            <div class="col-12 col-md-12 text-md-left mt-5">
              ...
              <p>
                ULO1- Able to produce a work plan for own area of responsibility
                Understanding the Scope of Responsibility, Setting Clear
                Objectives and Goals, Identifying Key Deliverables and
                Milestones, Time Management and Prioritization, Risk Assessment
                and Mitigation, Communication and Reporting.
              </p>
              <p>
                ULO2- Able to allocate and agree responsibilities with team
                members. Understanding Team Roles and Skills, Defining Project
                or Task Objectives, Matching Tasks to Team Members' Strengths,
                Involving Team Members in Allocation Process, Feedback and
                Performance Evaluation, Team Building and Collaboration.
              </p>
              <p>
                ULO3- Able to review and amend plans of work for own area of
                responsibility and communicate changes. Plan Review Process,
                Performance Evaluation, Gathering Feedback, Data Analysis and
                Evaluation, Amendment Criteria, Problem-Solving and Decision
                Making, Understanding and Buy-In, Tracking Progress
                Post-Amendment, Documentation and Record Keeping
              </p>
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>CIQ/L4017/401</td>
                      <td>
                        The principles and practices of internally assuring the
                    ...
                    <tr>
                      <td>2</td>
                      <td>CIQ/L4017/402</td>
                      <td>Internally assure the quality of assessment</td>
                      <td>Essential Unit</td>
                      <td>6</td>
                      <td>20</td>
                      <td>60</td>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <ul class="learning-checklist">
                    ...
                    <li>
                      <i class="icon icon-check"></i>
                      Assess knowledge and understanding of the principles and
                      practices that underpin the internal quality assurance of
                      assessment;
                    </li>
                    <li>
                      <i class="icon icon-check"></i>
                      Assess the trainee IQA’s performance in assuring the
                      quality of assessment from within an organization or
                      assessment center.
                    </li>
                  </ul>
                </div>
    ...
    >
      <div class="container">
        <h3 class="text-center">
          Why Choose ASTI for Level 4 Certificate In Leading The Internal
          Quality Assurance Of Assessment Processes AND Practices?
        </h3>
        <div class="row justify-content-center text-center items">
          <div class="col-12 col-md-6 col-lg-4 item">
            <div class="card no-hover">
              <i class="icon icon-globe"></i>
              <h4>Globally Recognized & Accredited</h4>
              <p>
                This accreditation ensures that the level 3 accounting courses
                offered by ASTI meet high standards of quality and that
                graduates are well-prepared for careers .
              </p>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-4 item">
            <div class="card no-hover">
              ...
              <p>
                ASTI offers a variety of flexible learning options, including
                both on-campus and online courses. This can be especially
                beneficial for students who are working or have other
                commitments.
              </p>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-4 item">
            <div class="card no-hover">
              ...
              <p>
                The accounting faculty at ASTI includes highly experienced
                professionals who have worked in the industry for many years.
                They bring a wealth of real-world experience to the classroom.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-12">
            ...
            <p>
              ASTI Academy is Recognized & Accredited by the Government of
              Dubai, KHDA, Ofqual, and multiple global educational legal bodies,
              proving government-approved vocational educational qualification
              programs in Dubai.
            </p>
          </div>
        </div>
    ...
    <section id="subscribe" class="section-6 subscribe">
      <div class="container smaller">
        ...
        <div class="faq-container">
          <div class="faq">
            <h5 class="faq-title">
              Will a Level 3 foundation diploma from ASTI get me into
              university?
            </h5>
            <p class="faq-text">
              Yes. Level 3 foundation diploma from ASTI enables the learners to
              join universities for higher education qualifications.
            </p>
          ...
          <div class="faq">
            <h5 class="faq-title">What year is level 3 at university?</h5>
            <p class="faq-text">
              Year 12. AS-levels are a Level 3 qualification, studied in Year
              12.
            </p>
            <button class="faq-toggle">
              <svg
          ...
          <div class="faq">
            ...
            <p class="faq-text">
              A student studying a Level 3 foundation Diploma will study a
              course equivalent to the A-Level standard and is also a
              qualification that can be used for entry into a Degree course.
            </p>
            <button class="faq-toggle">
              <svg
                class="chevron w-6 h-6 text-gray-800 dark:text-white"
          ...
          <div class="faq">
            <h5 class="faq-title">What's entry-level 3 mean?</h5>
            <p class="faq-text">
              If you’re intending to enter further education after secondary
              school, these are typically the minimum requirements for entry
              onto courses.
            </p>
            <button class="faq-toggle">
              <svg
          ...
          document.getElementById('hubspot-form').addEventListener('submit', async function (e) {
            ...
            const formData = {
              fields: [
                ...
                {
                  name: 'phone',
                  value: document.querySelector('[name="phone"]').value
                },
                {
                  name: 'course_title',
