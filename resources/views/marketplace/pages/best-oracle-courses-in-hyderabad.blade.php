        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-left">
                    ...
                    <h1 class="hero-title">
                        Master <span class="gradient-text">Oracle Technology</span> with
                        Hands-On Offline Training
                    </h1>
                    <p class="hero-subtitle">
                        Join our intensive offline Oracle Financials program with expert mentors, real-time projects, and
                        classroom-based sessions. Build industry-ready skills in ERP financial modules with personalized
                        mentor guidance.
                    </p>
    ...
    <section id="why-course" class="why-course-section">
        <div class="container">
            <div class="section-header">
                <h2>Why Choose Our Oracle Financials Offline Training?</h2>
                <p>
                    Experience the power of classroom-based oracle learning with personalized attention.
                </p>
            </div>
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>
                        Learn Oracle Financials modules (GL, AP, AR, FA, CM) with real-time instructor guidance.
                    </p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>
                        Work on ERP-based financial case studies and end-to-end implementations.
                    </p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>
                        Earn Oracle Financials certifications valued globally to boost your career.
                    </p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>
                        GOne-on-one mentorship from Oracle-certified professionals to guide you throughout your ERP learning
                        journey.
                    </p>
                </div>
            </div>
            ...
            <div class="instructors-grid">
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        <h3>Dr. Anil Reddy </h3>
                        <p class="instructor-role">Senior ERP Consultant (Ex-Oracle) </p>
                        <p class="instructor-bio">
                            15+ Years’ Experience in Oracle ERP Financials Implementation.
                        </p>
                ...
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        <h3>Sneha Gupta </h3>
                        <p class="instructor-role">Financial Systems Architect </p>
                        <p class="instructor-bio">
                            Expert in GL, AP, AR, SLA, and Integration.
                        </p>
                        <div class="instructor-stats">
                ...
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        <h3>Rahul Verma </h3>
                        <p class="instructor-role">ERP Solution Director </p>
                        <p class="instructor-bio">
                            Specialized in end-to-end ERP implementation for Fortune 500 companies.
                        </p>
                        <div class="instructor-stats">
                ...
                <div class="job-roles">
                    ...
                    <div class="roles-grid">
                        <div class="role-card">
                            ...
                            <h4>Oracle Financials Functional Consultant</h4>
                            <p>₹9L–15L</p>
                        </div>
                        <div class="role-card">
                            <i class="fas fa-chart-bar"></i>
                            <h4>ERP Finance Analyst </h4>
                            <p>₹10L–18L</p>
                        </div>
                        <div class="role-card">
                            <i class="fas fa-code"></i>
                            <h4>Oracle Fusion Cloud Consultant</h4>
                            <p>₹8L–14L</p>
                        </div>
                        <div class="role-card">
                            <i class="fas fa-link"></i>
                            <h4>ERP Implementation Specialist </h4>
                            <p>₹7L–12L</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        ...
                        <div class="student-info">
                            <h4>Rohit Kumar </h4>
                            <p>Oracle ERP Consultant at Infosys</p>
                            <div class="rating">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <p class="testimonial-text">
                        “The offline training in Hyderabad gave me practical exposure. I quickly cleared my Oracle
                        certification and landed my first ERP job.”
                    </p>
                </div>
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        <img src="https://images.pexels.com/photos/2379005/pexels-photo-2379005.jpeg?auto=compress&cs=tinysrgb&w=150"
                            alt="Student" />
                        <div class="student-info">
                            <h4>Megha Rao (ERP Analyst at Deloitte):</h4>
                            <p>ERP Analyst at Deloitte</p>
                            <div class="rating">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <p class="testimonial-text">
                        “Coming from an accounting background, the Oracle Financials program helped me transition into IT
                        consulting within 4 months.”
                    </p>
                </div>
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        ...
                        <div class="student-info">
                            <h4>Suresh Reddy </h4>
                            <p>Oracle Fusion Consultant at Cap Gemini</p>
                            <div class="rating">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <p class="testimonial-text">
                        “The real-world projects and peer learning in class made me confident in ERP implementations. Great
            ...
            <div class="faq-container">
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Yes, Oracle Financials certification is highly valued by companies in Hyderabad and India.
                        </p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Basic finance or accounting understanding helps; no heavy programming needed.
                        </p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Competitive fees with flexible payment / EMI options.
                        </p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Yes — resume help, interview prep, and local corporate tie-ups.
                        </p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Yes — we offer evening & weekend batches suitable for working professionals.
                        </p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    ...
                    <p>
                        Transforming finance & accounting careers through hands-on ERP training. Gain real-world Oracle
                        Financials expertise from industry-certified mentors in Hyderabad.
                    </p>
