...
@section('content')
                ...
                <div class="swiper-slide slide-center">
                    ...
                    <div class="slide-content row text-center">
                        <div class="col-12 mx-auto inner">
                            ...
                            <h6 style="color: #000">Build a Successful Career in Project Management with a Flexible Online
                                Diploma</h6>
                        </div>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="row intro">
                        <div class="col-12 p-0">
                            <h3 class="featured alt">
                                How Does Project Management Training Strengthen My Professional Foundation?
                            </h3>
                            <p style="text-align: justify">
                                This Project Management course equips you with essential project management fundamentals and
                                enhances your ability to plan, execute, and deliver projects successfully across industries.
                                The program covers core concepts ranging from project initiation and scope definition to
                                planning, execution, monitoring, risk management, and project closure.

                                Through structured methodologies and real-world project scenarios, you will develop strong
                                leadership, communication, and problem-solving skills while gaining practical exposure to
                                industry-standard tools and best practices. The training builds a solid foundation that
                                prepares you to manage complex projects, coordinate teams effectively, and meet
                                organizational objectives with confidence.

                                By the end of the program, you will be job-ready with the knowledge and practical competence
                                required to succeed as a professional Project Manager in today’s fast-paced, results-driven
                ...
                <div class="col-12 col-md-6">
                    <a href="#">
                        <img src="/frontend/assets/images/project-management.jpg" class="fit-image"
            ...
            <div id="section1" class="content-section" style="padding: 10px 0px ">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <p>
                            The Project Management program provides a comprehensive understanding of how to plan, execute,
                            monitor, and successfully deliver projects across various industries. The course covers
                            essential project management concepts, methodologies, and tools required to manage scope, time,
                            cost, quality, and risk effectively.

                            Designed for both beginners and working professionals, this program builds a strong foundation
                            in project leadership, team coordination, and decision-making, preparing learners to manage
                            real-world projects with confidence and professionalism.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div id="section2" class="content-section" style="padding: 10px 0px ">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <ul>
                            <li>
                                Understand Project Management Fundamentals: Develop a strong foundation in project
                                management principles, terminology, and best practices aligned with industry standards.
                            </li>
                            <li>
                                Apply Project Life Cycle and Methodologies: Gain practical knowledge of project life cycle
                                phases and commonly used methodologies to manage projects efficiently.
                            </li>
                            <li>
                                Develop Project Planning Skills: Learn to define project scope, create schedules, allocate
                                resources, and estimate costs to ensure successful project planning.
                            </li>
                            <li>
                                Execute and Lead Project Teams: Build leadership and communication skills to effectively
                                manage teams, stakeholders, and project activities.
                            </li>
                        </ul>
                    </div>
                </div>
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>4 Hours</td>
                                        <td>Provides an overview of project management concepts, roles, responsibilities,
                                            and the importance of project management across industries.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 2: Project Life Cycle and Methodologies</td>
                                        <td>6 Hours</td>
                                        <td>Covers project life cycle phases and commonly used methodologies, including
                                            traditional and modern project management approaches.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 3: Project Initiation and Scope Management</td>
                                        <td>6 Hours</td>
                                        <td>Focuses on project initiation processes, stakeholder identification, scope
                                            definition, and requirement management.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 4: Project Planning</td>
                                        <td>8 Hours</td>
                                        <td>Teaches detailed project planning techniques including scheduling, resource
                                            allocation, budgeting, and work breakdown structures.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 5: Project Execution and Team Management</td>
                                        <td>6 Hours</td>
                                        <td>Explores execution strategies, leadership skills, team coordination,
                                            communication, and stakeholder engagement.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 6: Project Monitoring and Controlling</td>
                                        <td>6 Hours</td>
                                        <td>Covers performance tracking, progress measurement, change control, quality
                                            management, and corrective actions.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 7: Project Risk Management</td>
                                        <td>5 Hours</td>
                                        <td>Introduces risk identification, analysis, mitigation strategies, and risk
                                            monitoring throughout the project lifecycle.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 8: Project Closure and Evaluation</td>
                                        <td>4 Hours</td>
                                        <td>Focuses on project closure activities, documentation, performance evaluation,
                                            and lessons learned.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 9: Project Management Tools and Software</td>
                                        <td>5 Hours</td>
                                        <td>Provides hands-on exposure to industry-standard project management tools and
                                            software for planning, tracking, and reporting.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul>
                                    <li>
                                        Understand core project management principles, methodologies, and the project life
                                        cycle.
                                    </li>
                                    <li>
                                        Develop the ability to plan, execute, monitor, and close projects effectively within
                                        scope, time, and budget.
                                    </li>
                                    <li>
                                        Gain practical skills in managing project risks, stakeholders, and cross-functional
                                        teams.
                                    </li>
                                    <li>
                                        Apply project management tools and techniques to support informed decision-making
                            ...
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Project Planning & Scheduling</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Project Life Cycle Management</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Risk Assessment & Mitigation</span>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Stakeholder & Communication Management</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Team Leadership & Coordination</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Cost, Time & Quality Management</span>
                                </div>
                            </div>
                        </div>
    ...
    <section id="features" class="section-2 odd offers" style="padding: 40px 0 !important">
        <div class="container">
            <h3 class="text-center">
                Why Choose ASTI Online for Project Management?
            </h3>
            <div class="row justify-content-center text-center items">
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>Study at your own pace with expert faculty guidance, designed to fit around your professional and
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Gain practical project management skills aligned with current industry standards and real-world
                            business practices.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Work on real-world projects, case studies, and scenarios that enhance your planning, execution,
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Open doors to high-paying jobs in chemical processing, energy,
                            and sustainability.
                        </p>
                    </div>
                </div>
        ...
        <div class="container smaller">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="faq-container col-12">
                    <div class="faq">
                        <h5 class="faq-title">What is Project Management?</h5>
                        <p class="faq-text">
                            Project Management is the discipline of planning, organizing, executing, and closing projects
                            efficiently to achieve specific goals within defined timelines and budgets.
                        </p>
                    ...
                    <div class="faq">
                        <h5 class="faq-title">Can I study this diploma online?</h5>
                        <p class="faq-text">
                            Yes, this diploma is delivered entirely online, allowing you to learn at your own pace with
                            flexible access to course materials and expert faculty support.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                    ...
                    <div class="faq">
                        ...
                        <p class="faq-text">
                            Graduates can pursue roles such as Project Coordinator, Project Manager, Team Lead, Program
                            Executive, or Operations Manager across various industries.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                    ...
                    <div class="faq">
                        ...
                        <p class="faq-text">
                            This program is open to students and working professionals. A basic educational background and
                            an interest in management or leadership roles are sufficient.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                    ...
                    <div class="faq">
                        ...
                        <p class="faq-text">
                            The duration varies based on learning pace, but most learners complete the program within a few
                            months.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <div class="faq">
                        <h5 class="faq-title">Is this diploma recognized by industries?</h5>
                        <p class="faq-text">
                            Yes, the curriculum is industry-aligned and designed to meet professional standards, making it
                            relevant and valued across multiple sectors.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
    ...
    <!-- Features -->
    <section id="why-project-management" class="why-section">
        <div class="container">
            <div class="why-header">
                <h3>What are the 4 reasons to study Project Management?</h3>
            </div>
            ...
            <div class="why-grid">
                <div class="why-card">
                    ...
                    <p>
                        Project managers are in high demand across industries such
                        as construction, IT, engineering, healthcare, and business
                        operations.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <p>
                        As organizations rely more on structured planning and
                        execution, project management skills remain essential in
                        agile, digital, and global environments.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <h4>Flexible Online Learning</h4>
                    <p>
                        Learn anytime, anywhere—ideal for working professionals
                        looking to upskill while balancing work and life.
                    </p>
                </div>

                <div class="why-card">
                    <i class="icon icon-layers"></i>
                    <h4>Strong Career Growth</h4>
                    <p>
                        Project management professionals enjoy leadership roles,
                        global opportunities, and competitive salary potential.
                    </p>
                </div>
            </div>
        </div>
