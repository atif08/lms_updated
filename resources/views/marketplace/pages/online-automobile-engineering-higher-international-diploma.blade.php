...
<!-- End Google Tag Manager  -->
    ...
    <title>Level 4 & 5 Online Automobile Diploma | Automobile Engineering - ASTI Online</title>

    <meta name="description" content="Online automobile engineering program is designed to advance your career with automobile skills, available entirely online through our automobile training institute." />
          ...
          >
            <div class="row intro">
              <div class="col-12 p-0">
                <h3 class="featured alt">Level 4 & 5 - Higher International Diploma in Automobile Engineering</h3>
                <p  style="text-align:justify">
                  The Level 4 & 5 Higher International Diploma in Automobile Engineering offers an in-depth study of automotive systems, technologies, and advancements. Exclusively online, this program caters to aspiring automobile engineers across the GCC. Designed for those aiming to build or advance their career in the automotive industry, it combines practical skills with theoretical knowledge in vehicle dynamics, powertrain systems, and automotive electronics. To advance your knowledge in the rapidly expanding profession of automotive engineering, enroll in one of Gulf best online courses in the subject.
                </p>
        ...
        <div id="section1" class="content-section">
          <div class="row">
            <div class="col-12 col-md-12 text-md-left mt-5">
              ...
              <p>
                The goal of this curriculum is to provide students a thorough understanding of automotive engineering. Through online automobile diploma courses, students will engage in a comprehensive curriculum that covers engine systems, vehicle technology, and automotive design. The online learning format ensures flexibility for working professionals, allowing them to learn at their own pace while gaining globally recognized qualifications. The program includes case studies, interactive sessions, and assessments to ensure practical learning in an entirely virtual environment.
        ...
        <div id="section2" class="content-section">
          <div class="row">
            <div class="col-12 col-md-12 text-md-left mt-5">
              ...
              <p>
                The Higher International Diploma in Automobile Engineering is crafted to equip students with both fundamental and advanced knowledge of automotive systems, enabling them to:
              </p>
              <ul>
                <li>Understand the principles and practices of automobile engineering.</li>
                <li>Develop problem-solving skills in the design, development, and testing of vehicles.</li>
                <li>Apply modern technologies and innovations in the automotive industry.</li>
                <li>Foster a global perspective on automobile engineering and environmental sustainability.</li>
                <li>Prepare for leadership roles within the automotive sector across Oman, Kuwait, Qatar, Bahrain, Saudi.</li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div class="table-responsive">
                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>4</td>
                      <td>	Mechanical System in Automobile</td>
                      <td>12 Credits</td>
                    </tr>
                    <tr>
                      <td>5</td>
                      <td>Applied Mathematics for Automobile Engineering</td>
                      <td>12 Credits</td>
                    </tr>
                    <tr>
                      <td>6</td>
                    ...
                    <tr>
                      <td>7</td>
                      <td>	Vehicle Body Engineering</td>
                      <td>12 Credits</td>
                    </tr>
                    <tr>
                      <td>8</td>
                      <td>	Automotive Transmission</td>
                      <td>12 Credits</td>
                    </tr>
                    <tr>
                      <td>9</td>
                    ...
                    <tr>
                      <td>10</td>
                      <td>Hydraulic and Pneumatic Systems</td>
                      <td>12 Credits</td>
                    </tr>
                    <tr>
                      <td>11</td>
                    ...
                    <tr>
                      <td>12</td>
                      <td>Electrical and Electronics in Automobile</td>
                      <td>15 Credits</td>
                    </tr>
                    <tr>
                      <td>13</td>
                      <td>Modeling and Simulation of Automotive Systems</td>
                      <td>15 Credits</td>
                    </tr>
                    <tr>
                      <td>14</td>
                      <td>	Fitting Operations in Automobile</td>
                      <td>15 Credits</td>
                    </tr>
                    <tr>
                      <td>15</td>
                      <td>	Advanced Vehicle Concepts</td>
                      <td>15 Credits</td>
                    </tr>
                    <tr>
                      <td>16</td>
                      <td>Automotive HVAC</td>
                      <td>15 Credits</td>
                    </tr>
                    <tr>
                      <td>17</td>
            ...
            <div class="col-12 col-md-12 text-md-left mt-5">
              ...
              <div class="table-responsive">
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      <td>Level 4 & 5 - Higher International Diploma in Automobile Engineering</td>
                      <td>UK Level 5</td>
                      <td>Accredited</td>
                      <td>240 Credits</td>
          ...
          <div class="row">
            <div class="col-12 col-md-12 text-md-left mt-5">
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul>
                    <li>                    Master key automotive engineering principles, including mechanical and electrical systems.
                    </li>
                    <li>
                      Examine and fix car parts to guarantee best possible performance.                    </li>
                    <li>Gain proficiency in automotive diagnostics and repair techniques.</li>
                    <li>Understand the future trends in automotive technology, such as electric and autonomous vehicles.</li>
                    <li>Develop expertise in automotive design and manufacturing processes.</li>
                    <li>Build essential project management and communication skills for the automotive industry.</li>
                  </ul>
    ...
    >
      <div class="container">
        <h3 class="text-center">
          Why Choose ASTI Online for Level 4 & 5 <br/> Higher International Diploma in Automobile Engineering?        </h3>
        <div class="row justify-content-center text-center items">
          <div class="col-12 col-md-6 col-lg-4 item">
            <div class="card no-hover">
              ...
              <p>
                Study from anywhere in the world or across Oman, Kuwait, Qatar, Bahrain, Saudi with our entirely online automobile engineering courses.
              </p>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-4 item">
            <div class="card no-hover">
              ...
              <p>
                Our courses are designed by automotive experts, ensuring up-to-date knowledge and skills.              </p>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-4 item">
            <div class="card no-hover">
              ...
              <p>
                ASTI's diploma is internationally recognized, opening doors to career opportunities worldwide.              </p>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-4 item">
            <div class="card no-hover">
              ...
              <p>
                Engage in hands-on projects and real-world case studies, even in an online setting.              </p>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-4 item">
            <div class="card no-hover">
              ...
              <p>
                Learn from experienced professionals who bring years of automotive industry expertise              </p>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-4 item">
            <div class="card no-hover">
              ...
              <p>
                Benefit from our dedicated career services, helping you secure roles in top automotive companies.              </p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="subscribe" class="section-6 subscribe">
      <div class="container smaller">
        ...
        <div class="faq-container">
          <div class="faq">
            <h5 class="faq-title">
              What is the duration of the Level 4 & 5 Higher International Diploma in Automobile Engineering?            </h5>
            <p class="faq-text">
              It usually takes 12–18 months to finish the course, depending on how quickly you study.
            </p>
          ...
          <div class="faq">
            ...
            <p class="faq-text">
              Yes, our diploma is recognized globally, providing career opportunities in the GCC and beyond.
            </p>
            <button class="faq-toggle">
              <svg
                class="chevron w-6 h-6 text-gray-800 dark:text-white"
          ...
          <div class="faq">
            ...
            <p class="faq-text">
              Yes, the program is designed for working professionals, offering a flexible online format.
          ...
          <div class="faq">
            ...
            <p class="faq-text">
              A high school diploma or foundation in automobile engineering or equivalent is required, along with a strong interest in automobile engineering.
            </p>
            <button class="faq-toggle">
              <svg
                class="chevron w-6 h-6 text-gray-800 dark:text-white"
          ...
          <div class="faq">
            ...
            <p class="faq-text">
              Classes are conducted entirely online through our advanced learning platform, featuring live sessions, recorded lectures, and interactive discussions.
            </p>
            <button class="faq-toggle">
              <svg
                class="chevron w-6 h-6 text-gray-800 dark:text-white"
          ...
          <div class="faq">
            <h5 class="faq-title">
              What level of assistance can I expect from the program?
            </h5>
            <p class="faq-text">
              Throughout the program, you will have access to career services, faculty support, and academic advisors.
          ...
          <div class="faq">
            <h5 class="faq-title">
              What opportunities for employment exist once this diploma is earned?
            </h5>
            <p class="faq-text">
              Graduates in the GCC can work in related sectors such as vehicle design and automotive engineering globally.
          ...
          <div class="faq">
            <h5 class="faq-title">
              Will I receive practical training in this online course?            </h5>
            <p class="faq-text">
              Yes, the course includes case studies, virtual labs, and projects to ensure practical learning.
            </p>
            <button class="faq-toggle">
              <svg
                class="chevron w-6 h-6 text-gray-800 dark:text-white"
          ...
          <div class="faq">
            <h5 class="faq-title">
              How much does the program cost?            </h5>
            <p class="faq-text">
              Tuition fees vary, so we recommend contacting ASTI Academy for the latest fee structure
            </p>
            <button class="faq-toggle">
              <svg
                class="chevron w-6 h-6 text-gray-800 dark:text-white"
          ...
          <div class="faq">
            <h5 class="faq-title">
              Is there any financial aid available?            </h5>
            <p class="faq-text">
              Yes, we offer a range of payment plans and scholarships to support students financially.
                ...
                <div class="row card">
                  <div class="col-12">
                    <img
                      ...
                      class="person"
                    />
                    <h4>Sara, Abu Dhabi</h4>
                    <p  style="text-align:justify">
                      ASTI Academy’s online automobile diploma helped me advance my career while working full-time. The flexible format made it possible to study at my own pace.                    </p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide slide-center text-center item">
                <div class="row card">
                  <div class="col-12">
                    ...
                    <p  style="text-align:justify">
                      The Level 4 & 5 diploma opened new doors for me in the GCC automotive industry. The knowledge and skills I gained were invaluable                    </p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide slide-center text-center item">
                <div class="row card">
                  <div class="col-12">
                    ...
                    <h4>Amira, UAE</h4>
                    <p style="text-align:justify">
                      The quality of teaching and the practical applications of what we learned pleased me.                    </p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide slide-center text-center item">
                <div class="row card">
                  <div class="col-12">
                    <img
                      ...
                      class="person"
                    />
                    <h4> Mohammed, Saudi Arabia</h4>
                    <p style="text-align:justify">
                      Even when students are learning online, the tutors are up to date and available to assist them                    </p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide slide-center text-center item">
                <div class="row card">
                  <div class="col-12">
                    ...
                    <h4>Huda, Oman</h4>
                    <p style="text-align:justify">
                      Studying online with ASTI was a smooth experience, and the course content was highly relevant to today’s automotive industry
                    </p>
                  </div>
                </div>
              </div>
...
const pdfUrl = "assets/pdf/Diploma in Toursim and Hospitality (Level 4 & 5).pdf";
const pdfName = "Diploma in Toursim and Hospitality (Level 4 & 5)";
          if (pdfUrl) {
