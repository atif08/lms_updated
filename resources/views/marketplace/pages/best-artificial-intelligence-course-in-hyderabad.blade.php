...
@section('content')
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-left">
                    ...
                    <h1 class="hero-title">
                        Master <span class="gradient-text">AI & Technology</span> with
                        Hands-On Offline Training
                    </h1>
                    <p class="hero-subtitle">
                        “Join ASTI Academy’s expert-led programs designed for Hyderabad students. Experience real-time
                        projects, classroom mentorship, and career-oriented learning — right here in your city.”
                    </p>
    ...
    <section id="why-course" class="why-course-section">
        <div class="container">
            <div class="section-header">
                <h2>Why Choose Our Offline Training?</h2>
                <p>
                    Experience the advantage of classroom learning with personalized
                    attention
                </p>
            </div>
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>
                        Learn directly from expert instructors in interactive classroom
                        sessions with real-time feedback and guidance.
                    </p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>
                        Work on industry-relevant projects that mirror actual workplace
                        challenges and build your portfolio.
                    </p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>
                        Earn certificates that are valued by top companies and enhance
                ...
                <div class="feature-card">
                    ...
                    <p>
                        Get one-on-one mentorship from industry professionals who guide
        ...
        <div class="container">
            ...
            <div class="highlights-grid">
                <div class="highlight-card">
                    ...
                    <p>
                        Master Python syntax, data structures, algorithms, and
                ...
                <div class="highlight-card">
                    ...
                    <p>
                        Work with powerful libraries like NumPy, Pandas, Matplotlib for
                ...
                <div class="highlight-card">
                    ...
                    <p>
                        Implement ML algorithms, build predictive models, and understand
                ...
                <div class="highlight-card">
                    ...
                    <h3>Real-World Projects</h3>
                    <p>
                        Build end-to-end projects including web apps, ML models, and data
                        analysis dashboards.
                    </p>
                    <ul>
            ...
            <div class="instructors-grid">
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        ...
                        <p class="instructor-role">AI/ML Lead at Google</p>
                        <p class="instructor-bio">
                            Former Senior Data Scientist at Microsoft with 12+ years of
                            experience. PhD in Computer Science, published 50+ research
                            papers in AI/ML.
                        </p>
                ...
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        ...
                        <p class="instructor-role">Senior Software Architect</p>
                        <p class="instructor-bio">
                            Ex-Amazon engineer with 15 years in software development. Expert
                            in Python, blockchain, and scalable systems architecture.
                        </p>
                        <div class="instructor-stats">
                ...
                <div class="instructor-card">
                    ...
                    <div class="instructor-info">
                        <h3>Priya Sharma</h3>
                        <p class="instructor-role">Data Science Director</p>
                        <p class="instructor-bio">
                            Former Analytics Head at Tesla. Specializes in big data, machine
                            learning, and business intelligence with 10+ years experience.
                        </p>
                        <div class="instructor-stats">
    ...
    <section id="career-outcomes" class="career-outcomes-section">
        <div class="container">
            <div class="section-header">
                <h2>Your Future Career Awaits</h2>
    ...
    <section id="testimonials" class="testimonials-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Hear from our successful graduates</p>
            </div>
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        "The offline training was incredible! The hands-on approach and
                        direct mentor interaction helped me land my dream job at
                        Microsoft. The classroom environment made all the difference."
                    </p>
                </div>
                <div class="testimonial-card">
                    <div class="testimonial-header">
                    ...
                    <p class="testimonial-text">
                        "Switched from finance to AI/ML thanks to this program. The
                        offline format with real projects and peer collaboration was
                        exactly what I needed. Got placed at Amazon within 2 months!"
                    </p>
                </div>
                <div class="testimonial-card">
                    <div class="testimonial-header">
                    ...
                    <p class="testimonial-text">
                        "As a working professional, the weekend offline classes were
                        perfect. The instructors' real-world experience and networking
                        opportunities led to a 60% salary increase!"
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="faq-container">
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Yes. Our AI certification is recognized by leading industry bodies and employers, ensuring
                            credibility and global acceptance in the AI/ML domain.
                        </p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What are the prerequisites for joining?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>
                            Basic knowledge of programming (Python preferred) and mathematics (linear algebra, statistics)
                            is recommended. However, beginners can start with our foundation modules.
                        </p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            We offer flexible payment plans and installment options to make the AI program accessible.
                            Detailed fee structures will be shared upon enrollment.
                        </p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Absolutely. We offer dedicated career support including resume building, mock interviews, and
                            direct connections with hiring partners specializing in AI and data science.
                        </p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Can I attend classes if I'm working full-time?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>
                            Yes. We provide multiple batch options — weekday mornings, evenings, and weekend intensive
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Will I work on real-world AI projects?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>
                            Yes. You’ll gain hands-on experience through 15+ real-world projects, including computer vision,
                            NLP, predictive analytics, and AI-driven applications.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    ...
                    <p>
                        Transforming careers through hands-on Artificial Intelligence training in Hyderabad. Join the future
                        of technology education with expert mentors and real-world AI projects.
                    </p>
