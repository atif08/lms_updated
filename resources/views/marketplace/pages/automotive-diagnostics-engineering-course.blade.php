...
@section('content')
                    ...
                    <div class="slide-content row text-center">
                        <div class="col-12 mx-auto inner">
                            <h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text"
                                ...
                                Automative Diagnostics Engineering Course
                            </h1>
                            <h6 style="color: #000">Build a Successful Career in Automative Diagnostics Engineering
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="row intro">
                        <div class="col-12 p-0">
                            <h3 class="featured alt">
                                How Does Automotive Diagnostics Engineering Training Strengthen My Professional Foundation?
                            </h3>
                            <p style="text-align: justify">
                                This Automotive Diagnostics Engineering programme equips you with essential technical
                                knowledge and hands-on skills required to diagnose, analyze, and troubleshoot modern vehicle
                                systems effectively. The course covers core concepts ranging from automotive electrical and
                                electronic fundamentals to engine management systems, transmission diagnostics, braking
                                systems, and advanced vehicle electronics.

                                You will gain a strong understanding of how modern vehicles operate by working with
                                real-world diagnostic techniques, fault detection methods, and industry-standard diagnostic
                                tools. Through structured learning and practical exposure, you will develop the ability to
                                identify common vehicle issues, interpret fault codes, analyze sensor data, and perform
                                systematic troubleshooting across mechanical, electrical, and electronic systems.

                                The programme also introduces advanced automotive technologies such as ECU diagnostics, CAN
                                and LIN networks, hybrid and electric vehicle basics, and professional diagnostic software.
                                By working on real diagnostic scenarios and case-based learning, you will strengthen your
                                analytical, problem-solving, and technical decision-making skills.

                                By the end of the programme, you will have a solid professional foundation to work
                                confidently in automotive diagnostics, vehicle servicing, and advanced automotive
                                engineering roles. This training prepares you to pursue opportunities as an Automotive
                                Diagnostic Engineer, Service Technician, or Automotive Electronics Specialist within today’s
                ...
                <div class="col-12 col-md-6">
                    <a href="#">
                        <img src="/frontend/assets/images/automative-diagnostics.jpg" class="fit-image"
            ...
            <div id="section1" class="content-section" style="padding: 10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <p>
                            The Automotive Diagnostics Engineering Course provides a comprehensive understanding of modern
                            vehicle diagnostic techniques used to identify, analyze, and resolve faults in today’s advanced
                            automotive systems. The programme covers essential topics including automotive electrical and
                            electronic fundamentals, engine management systems, transmission diagnostics, braking and safety
                            systems, and advanced vehicle electronics.

                            Designed for both beginners and working professionals, the course emphasizes practical, hands-on
                            learning through systematic diagnostic methodologies, real-world fault scenarios, and the use of
                            industry-standard diagnostic tools and software. Learners gain in-depth knowledge of ECU
                            operation, sensors and actuators, onboard diagnostics (OBD), vehicle communication networks, and
                            hybrid and electric vehicle basics.

                            By the end of the course, learners will develop strong diagnostic, analytical, and
                            troubleshooting skills required to work confidently with modern vehicles. The programme prepares
                            participants for roles in automotive diagnostics, vehicle service engineering, and advanced
                            automotive maintenance within today’s technology-driven automotive industry.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div id="section2" class="content-section" style="padding: 10px 0px">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <ul>
                            <li>
                                <b>Understand Automotive Diagnostic Fundamentals:</b> Develop a strong foundation in
                                automotive diagnostics, including vehicle systems, diagnostic principles, and the role of
                                diagnostics in modern automotive engineering.
                            </li>

                            <li>
                                <b>Apply Electrical and Electronic Diagnostic Techniques:</b> Gain practical knowledge of
                                automotive electrical and electronic systems, sensors, actuators, and wiring diagrams to
                                identify and resolve faults accurately.
                            </li>

                            <li>
                                <b>Analyze Engine and Drivetrain Systems:</b> Learn to diagnose engine management,
                                transmission, and drivetrain systems using systematic troubleshooting methods and
                                industry-standard diagnostic tools.
                            </li>

                            <li>
                                <b>Perform Advanced Vehicle Diagnostics:</b> Understand ECU diagnostics, vehicle
                                communication networks, braking and safety systems, and hybrid or electric vehicle basics to
                                handle complex automotive diagnostic challenges.
                            </li>
            ...
            <div id="section3" class="content-section" style="padding: 10px 0px">
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Module 1: Introduction to Automotive Diagnostics</td>
                                        <td>5 Hours</td>
                                        <td>Fundamentals of vehicle diagnostics, systems overview, and workshop safety.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 2: Automotive Electrical and Electronics Fundamentals</td>
                                        <td>6 Hours</td>
                                        <td>Basics of automotive electrical circuits, electronics, sensors, and actuators.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 3: Engine Management Systems Diagnostics</td>
                                        <td>8 Hours</td>
                                        <td>Diagnosis of fuel injection, ignition systems, sensors, and ECU fault codes.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 4: Transmission and Drivetrain Diagnostics</td>
                                        <td>6 Hours</td>
                                        <td>Fault detection in manual and automatic transmissions and drivetrain systems.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 5: Braking and Safety Systems Diagnostics</td>
                                        <td>6 Hours</td>
                                        <td>Diagnostics of braking, ABS, EBD, and vehicle safety systems.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 6: Advanced Automotive Electronics</td>
                                        <td>6 Hours</td>
                                        <td>Vehicle networks, advanced sensors, ADAS basics, and EV diagnostics.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 7: Diagnostic Tools and Software</td>
                                        <td>5 Hours</td>
                                        <td>Use of scan tools, oscilloscopes, and diagnostic software for fault analysis.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 8: Systematic Problem Solving</td>
                                        <td>6 Hours</td>
                                        <td>Step-by-step troubleshooting using diagnostic flowcharts and real cases.
                                        </td>
                                    </tr>
            ...
            <div id="section4" class="content-section" style="padding: 10px 0px">
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Automotive Diagnostics Engineering</td>
                                        <td>100% Online</td>
                    ...
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul>
                                    <li>
                                        Understand the fundamentals of automotive diagnostics, including vehicle systems,
                                        diagnostic principles, and fault identification.
                                    </li>
                                    <li>
                                        Apply electrical and electronic diagnostic techniques to analyze sensors, actuators,
                                        wiring, and control units.
                                    </li>
                                    <li>
                                        Diagnose engine, transmission, braking, and safety systems using systematic
                                        troubleshooting methods.
                                    </li>
                                    <li>
                                        Use industry-standard diagnostic tools and software to interpret fault codes and
                            ...
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Automotive fault diagnosis and troubleshooting</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Electrical and electronic system testing</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Engine management and ECU diagnostics</span>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Use of diagnostic scan tools and software</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Vehicle communication networks and sensors
                                        analysis</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Systematic problem-solving and technical
                                        reporting</span>
                                </div>
                            </div>
                        </div>
    ...
    <section id="features" class="section-2 odd offers" style="padding: 40px 0 !important">
        <div class="container">
            <h3 class="text-center">
                Why Choose ASTI Online for Automotive Diagnostics Engineering?
            </h3>
            <div class="row justify-content-center text-center items">
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Gain practical knowledge aligned with modern automotive industry standards, covering advanced
                            diagnostics, vehicle electronics, ECU systems, and emerging automotive technologies.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Learn through real-world diagnostic scenarios, case-based assignments, and practical exposure to
                            industry-standard diagnostic tools and software.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Prepare for in-demand roles in automotive diagnostics, vehicle servicing, and automotive
                            electronics with skills that enhance employability and career growth.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container smaller">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="faq-container col-12">
                    <div class="faq">
                        <h5 class="faq-title">Who can enroll in the Automotive Diagnostics Engineering Course?</h5>
                        <p class="faq-text">
                            This course is suitable for students, diploma holders, graduates, and working professionals from
                            automotive, mechanical, or related technical backgrounds who wish to develop practical
                            diagnostic skills.
                        </p>
                    ...
                    <div class="faq">
                        <h5 class="faq-title">Do I need prior automotive experience to join this course?</h5>
                        <p class="faq-text">
                            No prior experience is mandatory. The course begins with fundamental concepts and gradually
                            advances to complex diagnostic techniques, making it suitable for beginners as well as
                            professionals.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <div class="faq">
                        ...
                        <p class="faq-text">
                            ...
                            professionals to upskill without affecting their work schedules.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                    ...
                    <div class="faq">
                        <h5 class="faq-title">What diagnostic tools and software will be covered?</h5>
                        <p class="faq-text">
                            Learners will gain exposure to industry-standard diagnostic scan tools, OBD systems, ECU
                            diagnostics software, and basic oscilloscope usage.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                    ...
                    <div class="faq">
                        ...
                        <p class="faq-text">
                            Yes. A course completion certificate will be awarded upon successful completion of the
                            programme, including required assignments and assessments.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                    ...
                    <div class="faq">
                        <h5 class="faq-title">What career opportunities are available after completing this course?</h5>
                        <p class="faq-text">
                            Graduates can pursue roles such as Automotive Diagnostic Engineer, Service Technician, Vehicle
                            Electronics Specialist, or Automotive Service Advisor across dealerships, service centers, and
    ...
    <!-- Features -->
    <section id="why-automotive-diagnostics" class="why-section">
        <div class="container">
            <div class="why-header">
                <h3>What are the 4 reasons to study Automotive Diagnostics Engineering?</h3>
            </div>

            <div class="why-grid">
                <div class="why-card">
                    <i class="icon icon-globe"></i>
                    <h4>Growing Demand in the Automotive Industry</h4>
                    <p>
                        With increasing vehicle complexity and advanced electronic
                        systems, skilled automotive diagnostics professionals are
                ...
                <div class="why-card">
                    ...
                    <p>
                        Modern vehicles rely on ECUs, sensors, and intelligent
                        diagnostic systems, making this an ideal tech-focused
                        automotive career.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <p>
                        Learn real-world diagnostics, troubleshooting techniques,
                        and industry-standard tools to become job-ready.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <p>
                        Pursue roles such as Automotive Diagnostic Engineer,
                        Service Technician, Vehicle Electronics Specialist, or
                        Technical Advisor.
                    </p>
                </div>
            </div>
