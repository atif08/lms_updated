...
@section('content')
                ...
                <div class="swiper-slide slide-center">
                    ...
                    <div class="slide-content row text-center">
                        <div class="col-12 mx-auto inner">
                            ...
                            <h6 style="color: #000">Build a Future in Chemical Engineering with a Flexible Online
                                Diploma</h6>
                        </div>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="row intro">
                        <div class="col-12 p-0">
                            <h3 class="featured alt">
                                What You Will Achieve from the Online Chemical Engineering
                                Diploma
                            </h3>
                            <p style="text-align: justify">
                                The Online Chemical Engineering Diploma provides a solid
                                foundation in chemical processes, industrial applications, and
                                sustainability. This program is designed to equip students
                                with the technical skills and knowledge needed to analyze,
                                design, and optimize chemical processes in industries such as
                                pharmaceuticals, energy, and manufacturing. By completing this
                                diploma, you will gain expertise in thermodynamics, reaction
                                engineering, and process safety, helping you secure career
                                opportunities in one of the world’s most essential industries.
                            </p>
                ...
                <div class="col-12 col-md-6">
                    <a href="#">
                        <img src="/frontend/assets/images/chemical-engineering-program-1.jpg" class="fit-image"
            ...
            <div id="section1" class="content-section" style="padding: 10px 0">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <p>
                            The Online Chemical Engineering Diploma offers a comprehensive
                            curriculum covering chemical process design, industrial safety,
                            and energy efficiency. This program integrates theoretical
                            concepts with practical applications, ensuring graduates have
                            the skills to work in diverse industries such as petrochemicals,
                            food processing, and environmental engineering. The flexible
                            online format allows students to learn at their own pace while
            ...
            <div id="section2" class="content-section" style="padding: 10px 0">
                <div class="row">
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <ul>
                            <li>
                                Develop a strong foundation in chemical engineering principles
                                and industrial processes.
                            </li>
                            <li>
                                Learn to design, analyze, and optimize chemical production
                                systems.
                            </li>
                            <li>
                                Understand process safety regulations and environmental
                                sustainability.
                            </li>
                            <li>
                                Gain proficiency in chemical thermodynamics, reaction
            ...
            <div id="section3" class="content-section" style="padding: 10px 0">
                <div class="row">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Module 1: Introduction to Chemical Engineering</td>
                                        <td>4 Hours</td>
                                        <td>An introduction to the core principles of chemical engineering, including basic
                                            concepts and the role of chemical engineers in various industries.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 2: Material and Energy Balances</td>
                                        <td>6 Hours</td>
                                        <td>Focus on the application of mass and energy conservation principles to analyze
                                            and solve chemical engineering problems in processes.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 3: Thermodynamics in Chemical Engineering</td>
                                        <td>6 Hours</td>
                                        <td>Explores the role of thermodynamics in chemical processes, including energy
                                            transfer, phase equilibria, and chemical reactions.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 4: Fluid Mechanics and Transport Phenomena</td>
                                        <td>6 Hours</td>
                                        <td>Covers the behavior of fluids in motion and at rest, as well as the transfer of
                                            momentum, heat, and mass in chemical systems.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 5: Chemical Reaction Engineering</td>
                                        <td>8 Hours</td>
                                        <td>Study of the rates and mechanisms of chemical reactions, reactor design, and
                                            optimization for various chemical processes.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 6: Process Control and Automation</td>
                                        <td>6 Hours</td>
                                        <td>Introduces the principles of process control systems and automation techniques
                                            used to regulate and optimize chemical processes.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 7: Separation Processes</td>
                                        <td>4 Hours</td>
                                        <td>Examines methods of separating components from mixtures, such as distillation,
                                            filtration, and membrane processes, in chemical engineering.</td>
                                    </tr>
                                    <tr>
                                        <td>Module 8: Environmental and Sustainability Issues</td>
                                        <td>4 Hours</td>
                                        <td>Focuses on the environmental impact of chemical processes and explores
                                            sustainable engineering practices to reduce pollution and resource consumption.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Module 9: Process Design and Simulation</td>
                                        <td>4 Hours</td>
                                        <td>Covers the design and simulation of chemical processes, including the use of
                                            software tools to model, optimize, and scale-up processes.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="col-12 col-md-12 text-md-left mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul>
                                    <li>
                                        Understand core chemical engineering principles and
                                        applications.
                                    </li>
                                    <li>
                                        Learn how to design and optimize chemical processes for
                                        industrial applications.
                                    </li>
                                    <li>
                                        Gain expertise in safety standards, environmental
                                        regulations, and process control.
                                    </li>
                                    <li>
                                        Develop problem-solving and analytical skills for chemical
                            ...
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Process Design and Analysis</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Chemical Kinetics and Thermodynamics</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Fluid Mechanics and Heat Transfer</span>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Process Control & Safety Skills</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Analytical & Problem-Solving Skills</span>
                                </div>
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <img src="/frontend/assets/svg/check-icon.svg" alt="Icon" width="26"
                                        height="26" />
                                    <span class="flex-grow-1 pl-2">Technical & Laboratory Skills</span>
                                </div>
                            </div>
                        </div>
    ...
    <section id="features" class="section-2 odd offers" style="padding: 40px 0 !important">
        <div class="container">
            <h3 class="text-center">
                Why Choose ASTI Online for Chemical Engineering?
            </h3>
            <div class="row justify-content-center text-center items">
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>Study at your own pace with expert faculty guidance.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Gain skills relevant to the chemical and manufacturing
                            industries.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Work on real-world case studies, simulations, and process
                            designs.
                        </p>
                    </div>
                </div>
    ...
    <section id="section7" class="section-3 highlights image-right" style="background-color: #fff; padding:20px 0px">
        <div class="container">
            <div class="row">
        ...
        <div class="container smaller">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="faq-container col-12">
                    <div class="faq">
                        <h5 class="faq-title">What is Chemical Engineering?</h5>
                        <p class="faq-text">
                            Chemical Engineering is a branch of engineering that applies
                            chemistry, physics, and mathematics to design, optimize, and
                            manage industrial chemical processes.
                        </p>
                    ...
                    <div class="faq">
                        ...
                        <p class="faq-text">
                            Yes, this program is completely online, allowing you to study from
                            anywhere while gaining practical experience through virtual labs
                            and simulations.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <div class="faq">
                        ...
                        <p class="faq-text">
                            Graduates can pursue careers in chemical manufacturing,
                            pharmaceuticals, energy production, environmental engineering, and
                    ...
                    <div class="faq">
                        ...
                        <p class="faq-text">
                            A background in science, chemistry, or engineering is preferred.
                    ...
                    <div class="faq">
                        ...
                        <p class="faq-text">
                            Yes, the diploma is recognized by industry professionals and
                            employers, enhancing your job prospects.
                        </p>
                        <button class="faq-toggle">
                            <svg class="chevron w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
    ...
    {{-- <section id="features" class="section-3" style="background-color: #fff">
        <div class="container">
            <div class="row text-center intro">
                <div class="col-12">
                    <h3>What are 4 reasons to study Chemical Engineering?</h3>
                </div>
            </div>
            <div class="row justify-content-center text-center items">
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            Chemical engineers are essential in manufacturing,
                ...
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            The chemical industry is evolving with green energy, AI-driven
                            processes, and sustainable manufacturing.
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        ...
                        <p>
                            ...
                            to upskill.Learn at your own pace while balancing work and
                            studies.
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 item">
                    <div class="card no-hover">
                        <i class="icon icon-layers"></i>
                        <h4 style="white-space: nowrap">Career Opportunities</h4>
                        <p>
                            Chemical engineers earn competitive salaries with excellent
    ...
    <section id="why-chemical" class="why-section">
        <div class="container">
            ...
            <div class="why-grid">
                <div class="why-card">
                    ...
                    <h4>High Industry Demand</h4>
                    <p>
                        Chemical engineers play a vital role in manufacturing,
                        sustainability, and energy-driven industries.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <h4>Future-Proof Career</h4>
                    <p>
                        The field is evolving with green energy, AI-driven processes,
                        and sustainable manufacturing innovations.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <h4>Flexible Online Learning</h4>
                    <p>
                        Learn from anywhere at your own pace while balancing work
                        commitments and academic growth.
                    </p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <p>
                        Chemical engineers enjoy competitive salaries and strong
