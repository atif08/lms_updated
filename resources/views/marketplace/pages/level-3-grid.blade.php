...
@section('content')
    <section class="category-section">
        <h2 class="category-title">UK Level-3 Courses</h2>
        ...
        <div class="grid-container">
            <div class="course-card">
                ...
                <div class="course-content">
                    <div class="course-name">Foundation Diploma in Accountancy</div>
            ...
            <div class="course-card">
                ...
                <div class="course-content">
                    <div class="course-name">Foundation Diploma in Higer Education</div>
                    <div class="course-info pricing">Price: $1999</div>
                    <div class="course-info">Duration: 12 Months/ 1 Year</div>
