                ...
                <div class="col-md-12 col-12">
                    <div class="breadcrumb-list">
                        ...
                        <nav aria-label="breadcrumb" class="page-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/') }}">{{ $item1 }}</a></li>
...
@if (Route::is(['checkout', 'courses.get.details']))
    <!-- Breadcrumb -->
                    ...
                    <div class="breadcrumb-list">
                        <nav aria-label="breadcrumb" class="page-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                @if (Route::is(['courses.get.details']))
...
@if(Route::is(['students-grid','students-list','blog-details','blog-grid','blog-list','blog-masonry','blog-modern','cart','courses.get','course-list','faq','help-center','job-category','notifications','pricing-plan','privacy-policy','support','term-condition','wishlist']))
	<!-- Breadcrumb -->
    <div class="breadcrumb-bar">
        <div class="container">
            <div class="row">
