         ...
         <div class="card-body">
             <ul class="latest-posts">
                 <li>
                     <div class="post-thumb">
                         <a href="{{ url('blog-details') }}">
                             <img class="img-fluid" src="{{ URL::asset('/frontend/img/blog/blog-01.jpg') }}"
                                 alt="">
                         </a>
                     </div>
                     <div class="post-info">
                         ...
                         <p><img class="img-fluid" src="{{ URL::asset('/frontend/img/icon/icon-22.svg') }}"
                                 alt="">14 Jun 2023</p>
                     </div>
                 </li>
                 <li>
                     <div class="post-thumb">
                         <a href="{{ url('blog-details') }}">
                             <img class="img-fluid" src="{{ URL::asset('/frontend/img/blog/blog-02.jpg') }}"
                                 alt="">
                         </a>
                     </div>
                     <div class="post-info">
                 ...
                 <li>
                     <div class="post-thumb">
                         <a href="{{ url('blog-details') }}">
                             <img class="img-fluid" src="{{ URL::asset('/frontend/img/blog/blog-03.jpg') }}"
                                 alt="">
                         </a>
                     </div>
                     <div class="post-info">
