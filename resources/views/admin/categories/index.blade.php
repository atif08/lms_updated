...
@section('extra-buttons')
    <a type="button" href="{{ route('categories.create') }}" class="btn btn-primary float-end">
        <i class="fa fa-plus"></i> | {{ __('Create Category') }}
    </a>
@endsection
...
@section('content')
    @component('components.admin.page-title')
        ...
        @slot('title'){{ __('Categories List') }}@endslot
    @endcomponent
