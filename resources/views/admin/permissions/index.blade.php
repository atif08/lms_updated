...
@section('extra-buttons')
    <a type="button" href="{{ route('permissions.create') }}" class="btn btn-primary float-end">
        <i class="fa fa-plus"></i> | {{ __('Create Permission') }}
    </a>
@endsection
...
@section('content')
    @component('components.admin.page-title')
        ...
        @slot('title'){{ __('Permissions List') }}@endslot
    @endcomponent
