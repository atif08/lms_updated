            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ ($question->id)
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 mb-2 mt-2">
                                <h4 class="card-title">Select the correct answer(s)*</h4>
                                            ...
                                            <div class="row mb-1">
                                                <div class="col-md-1 selection-list d-flex justify-content-center align-items-center">
                                                    <label class="answer-checkbox-label"
                                                           for="answer_status_{{ $index }}">
                                                        <input style="transform: scale(1.5);" type="checkbox"
                                                               class="answer_status" id="answer_status_{{ $index }}"
                                                               name="answer_status[]"
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="answer[]" class="form-control"
                                                           id="answer_{{ $index }}" value="{{ $answer->name }}"
                                                           placeholder="Enter a possible answer" autocomplete="off">
                                                </div>
...
@push('scripts')
    <script>
        ...
        <div class="answer" data-index="${index}">
            <div class="row mb-1">
<div class="col-md-1 selection-list d-flex justify-content-center align-items-center">
                    <label class="answer-checkbox-label" for="answer_status_${index}">
                        <input style="transform: scale(1.5);" type="checkbox" class="answer_status" id="answer_status_${index}" name="answer_status[]" value="${index}">
                    </label>
                </div>
                <div class="col-md-9">
